...
module ImGui
  # [struct ImVec2](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L259)
  struct ImVec2
    include StructType

    # [ImVec2::ImVec2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L262)
    def self.new : ImVec2
      result = LibImGui.ImVec2_ImVec2_Nil
      result.value
    end

    # [ImVec2::ImVec2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L263)
  ...
  # [struct ImVec4](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L272)
  struct ImVec4
    include StructType

    # [ImVec4::ImVec4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L275)
    def self.new : ImVec4
      result = LibImGui.ImVec4_ImVec4_Nil
      result.value
    end

    # [ImVec4::ImVec4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L276)
  ...
  # [ImGui::CreateContext()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L294)
  ...
  #
  # [ImGui::DestroyContext()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L295)
  def self.destroy_context(ctx : ImGuiContext? = nil) : Void
    LibImGui.DestroyContext(ctx)
  end

  # [ImGui::GetCurrentContext()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L296)
  def self.get_current_context : ImGuiContext
    result = LibImGui.GetCurrentContext
    result.value
  end

  # [ImGui::SetCurrentContext()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L297)
  ...
  #
  # [ImGui::GetIO()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L300)
  ...
  #
  # [ImGui::GetStyle()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L301)
  ...
  #
  # [ImGui::NewFrame()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L302)
  ...
  #
  # [ImGui::EndFrame()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L303)
  ...
  #
  # [ImGui::Render()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L304)
  ...
  #
  # [ImGui::GetDrawData()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L305)
  ...
  #
  # [ImGui::ShowDemoWindow()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L308)
  ...
  #
  # [ImGui::ShowMetricsWindow()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L309)
  ...
  #
  # [ImGui::ShowStackToolWindow()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L310)
  ...
  #
  # [ImGui::ShowAboutWindow()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L311)
  ...
  #
  # [ImGui::ShowStyleEditor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L312)
  ...
  #
  # [ImGui::ShowStyleSelector()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L313)
  ...
  #
  # [ImGui::ShowFontSelector()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L314)
  ...
  #
  # [ImGui::ShowUserGuide()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L315)
  ...
  #
  # [ImGui::GetVersion()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L316)
  ...
  #
  # [ImGui::StyleColorsDark()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L319)
  ...
  #
  # [ImGui::StyleColorsLight()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L320)
  ...
  # classic imgui style
  #
  # [ImGui::StyleColorsClassic()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L321)
  def self.style_colors_classic(dst : ImGuiStyle? = nil) : Void
    LibImGui.StyleColorsClassic(dst)
  end

  # [ImGui::Begin()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L335)
  ...
  # [ImGui::End()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L336)
  def self.end : Void
    LibImGui.End
  end

  # [ImGui::BeginChild()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L346)
  ...
  # [ImGui::BeginChild()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L347)
  ...
  # [ImGui::EndChild()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L348)
  def self.end_child : Void
    LibImGui.EndChild
  end

  # [ImGui::IsWindowAppearing()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L352)
  def self.is_window_appearing : Bool
    LibImGui.IsWindowAppearing
  end

  # [ImGui::IsWindowCollapsed()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L353)
  ...
  #
  # [ImGui::IsWindowFocused()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L354)
  ...
  #
  # [ImGui::IsWindowHovered()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L355)
  ...
  #
  # [ImGui::GetWindowDrawList()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L356)
  ...
  #
  # [ImGui::GetWindowPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L357)
  ...
  #
  # [ImGui::GetWindowSize()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L358)
  ...
  #
  # [ImGui::GetWindowWidth()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L359)
  ...
  #
  # [ImGui::GetWindowHeight()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L360)
  ...
  #
  # [ImGui::SetNextWindowPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L364)
  ...
  #
  # [ImGui::SetNextWindowSize()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L365)
  ...
  #
  # [ImGui::SetNextWindowSizeConstraints()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L366)
  ...
  #
  # [ImGui::SetNextWindowContentSize()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L367)
  ...
  #
  # [ImGui::SetNextWindowCollapsed()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L368)
  ...
  #
  # [ImGui::SetNextWindowFocus()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L369)
  ...
  #
  # [ImGui::SetNextWindowBgAlpha()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L370)
  ...
  #
  # [ImGui::SetWindowPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L371)
  ...
  #
  # [ImGui::SetWindowPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L376)
  ...
  #
  # [ImGui::SetWindowSize()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L372)
  ...
  #
  # [ImGui::SetWindowSize()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L377)
  ...
  #
  # [ImGui::SetWindowCollapsed()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L373)
  ...
  #
  # [ImGui::SetWindowCollapsed()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L378)
  ...
  #
  # [ImGui::SetWindowFocus()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L374)
  ...
  #
  # [ImGui::SetWindowFocus()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L379)
  ...
  #
  # [ImGui::SetWindowFontScale()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L375)
  ...
  #
  # [ImGui::GetContentRegionAvail()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L384)
  ...
  #
  # [ImGui::GetContentRegionMax()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L385)
  ...
  #
  # [ImGui::GetWindowContentRegionMin()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L386)
  ...
  #
  # [ImGui::GetWindowContentRegionMax()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L387)
  ...
  #
  # [ImGui::GetScrollX()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L390)
  ...
  #
  # [ImGui::GetScrollY()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L391)
  ...
  #
  # [ImGui::SetScrollX()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L392)
  ...
  #
  # [ImGui::SetScrollY()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L393)
  ...
  #
  # [ImGui::GetScrollMaxX()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L394)
  ...
  #
  # [ImGui::GetScrollMaxY()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L395)
  ...
  #
  # [ImGui::SetScrollHereX()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L396)
  ...
  #
  # [ImGui::SetScrollHereY()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L397)
  ...
  #
  # [ImGui::SetScrollFromPosX()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L398)
  ...
  # adjust scrolling amount to make given position visible. Generally GetCursorStartPos() + offset to compute a valid position.
  #
  # [ImGui::SetScrollFromPosY()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L399)
  ...
  #
  # [ImGui::PushFont()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L402)
  def self.push_font(font : ImFont) : Void
    LibImGui.PushFont(font)
  end

  # [ImGui::PopFont()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L403)
  ...
  #
  # [ImGui::PushStyleColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L404)
  def self.push_style_color(idx : ImGuiCol, col : UInt32) : Void
    LibImGui.PushStyleColor_U32(idx, col)
  end

  # [ImGui::PushStyleColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L405)
  def self.push_style_color(idx : ImGuiCol, col : ImVec4) : Void
    LibImGui.PushStyleColor_Vec4(idx, col)
  end

  # [ImGui::PopStyleColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L406)
  ...
  #
  # [ImGui::PushStyleVar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L407)
  ...
  #
  # [ImGui::PushStyleVar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L408)
  def self.push_style_var(idx : ImGuiStyleVar, val : ImVec2) : Void
    LibImGui.PushStyleVar_Vec2(idx, val)
  end

  # [ImGui::PopStyleVar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L409)
  ...
  #
  # [ImGui::PushAllowKeyboardFocus()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L410)
  def self.push_allow_keyboard_focus(allow_keyboard_focus : Bool) : Void
    LibImGui.PushAllowKeyboardFocus(allow_keyboard_focus)
  end

  # [ImGui::PopAllowKeyboardFocus()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L411)
  ...
  #
  # [ImGui::PushButtonRepeat()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L412)
  def self.push_button_repeat(repeat : Bool) : Void
    LibImGui.PushButtonRepeat(repeat)
  end

  # [ImGui::PopButtonRepeat()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L413)
  ...
  #
  # [ImGui::PushItemWidth()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L416)
  def self.push_item_width(item_width : Float32) : Void
    LibImGui.PushItemWidth(item_width)
  end

  # [ImGui::PopItemWidth()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L417)
  ...
  #
  # [ImGui::SetNextItemWidth()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L418)
  ...
  #
  # [ImGui::CalcItemWidth()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L419)
  ...
  #
  # [ImGui::PushTextWrapPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L420)
  def self.push_text_wrap_pos(wrap_local_pos_x : Float32 = 0.0) : Void
    LibImGui.PushTextWrapPos(wrap_local_pos_x)
  end

  # [ImGui::PopTextWrapPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L421)
  ...
  # get current font
  #
  # [ImGui::GetFont()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L425)
  ...
  #
  # [ImGui::GetFontSize()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L426)
  ...
  #
  # [ImGui::GetFontTexUvWhitePixel()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L427)
  ...
  #
  # [ImGui::GetColorU32()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L428)
  ...
  #
  # [ImGui::GetColorU32()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L429)
  ...
  # retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList
  #
  # [ImGui::GetColorU32()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L430)
  ...
  #
  # [ImGui::GetStyleColorVec4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L431)
  ...
  #
  # [ImGui::Separator()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L440)
  ...
  #
  # [ImGui::SameLine()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L441)
  ...
  #
  # [ImGui::NewLine()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L442)
  ...
  #
  # [ImGui::Spacing()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L443)
  ...
  #
  # [ImGui::Dummy()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L444)
  ...
  #
  # [ImGui::Indent()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L445)
  ...
  #
  # [ImGui::Unindent()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L446)
  ...
  #
  # [ImGui::BeginGroup()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L447)
  ...
  #
  # [ImGui::EndGroup()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L448)
  ...
  #
  # [ImGui::GetCursorPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L449)
  ...
  #
  # [ImGui::GetCursorPosX()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L450)
  ...
  #
  # [ImGui::GetCursorPosY()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L451)
  ...
  #
  # [ImGui::SetCursorPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L452)
  ...
  #
  # [ImGui::SetCursorPosX()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L453)
  def self.set_cursor_pos_x(local_x : Float32) : Void
    LibImGui.SetCursorPosX(local_x)
  end

  # [ImGui::SetCursorPosY()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L454)
  ...
  #
  # [ImGui::GetCursorStartPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L455)
  ...
  #
  # [ImGui::GetCursorScreenPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L456)
  ...
  #
  # [ImGui::SetCursorScreenPos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L457)
  ...
  #
  # [ImGui::AlignTextToFramePadding()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L458)
  ...
  # ~ FontSize
  #
  # [ImGui::GetTextLineHeight()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L459)
  ...
  #
  # [ImGui::GetTextLineHeightWithSpacing()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L460)
  ...
  #
  # [ImGui::GetFrameHeight()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L461)
  ...
  #
  # [ImGui::GetFrameHeightWithSpacing()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L462)
  ...
  #
  # [ImGui::PushID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L475)
  ...
  # push string into the ID stack (will hash string).
  #
  # [ImGui::PushID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L476)
  ...
  #
  # [ImGui::PushID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L477)
  ...
  #
  # [ImGui::PushID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L478)
  ...
  #
  # [ImGui::PopID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L479)
  ...
  #
  # [ImGui::GetID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L480)
  def self.get_id(str_id : String) : ImGuiID
    LibImGui.GetID_Str(str_id)
  end

  # [ImGui::GetID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L481)
  def self.get_id(str_id : Bytes | String) : ImGuiID
    LibImGui.GetID_StrStr(str_id, (str_id.to_unsafe + str_id.bytesize))
  end

  # [ImGui::GetID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L482)
  ...
  #
  # [ImGui::TextUnformatted()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L485)
  ...
  # formatted text
  #
  # [ImGui::Text()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L486)
  ...
  #
  # [ImGui::TextColored()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L488)
  ...
  #
  # [ImGui::TextDisabled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L490)
  ...
  #
  # [ImGui::TextWrapped()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L492)
  ...
  #
  # [ImGui::LabelText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L494)
  ...
  #
  # [ImGui::BulletText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L496)
  ...
  # button
  #
  # [ImGui::Button()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L502)
  ...
  #
  # [ImGui::SmallButton()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L503)
  ...
  #
  # [ImGui::InvisibleButton()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L504)
  ...
  #
  # [ImGui::ArrowButton()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L505)
  def self.arrow_button(str_id : String, dir : ImGuiDir) : Bool
    LibImGui.ArrowButton(str_id, dir)
  end

  # [ImGui::Image()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L506)
  ...
  #
  # [ImGui::ImageButton()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L507)
  ...
  # [ImGui::Checkbox()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L508)
  pointer_wrapper def self.checkbox(label : String, v : Bool*) : Bool
    LibImGui.Checkbox(label, v)
  end
  # [ImGui::CheckboxFlags()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L509)
  ...
  # [ImGui::CheckboxFlags()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L510)
  ...
  #
  # [ImGui::RadioButton()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L511)
  pointer_wrapper def self.radio_button(label : String, active : Bool) : Bool
    LibImGui.RadioButton_Bool(label, active)
  end
  # shortcut to handle the above pattern when value is an integer
  #
  # [ImGui::RadioButton()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L512)
  ...
  # [ImGui::ProgressBar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L513)
  ...
  #
  # [ImGui::Bullet()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L514)
  def self.bullet : Void
    LibImGui.Bullet
  end

  # [ImGui::BeginCombo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L519)
  ...
  #
  # [ImGui::EndCombo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L520)
  def self.end_combo : Void
    LibImGui.EndCombo
  end

  # [ImGui::Combo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L521)
  ...
  #
  # [ImGui::Combo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L522)
  ...
  # [ImGui::Combo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L523)
  ...
  #
  # [ImGui::DragFloat()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L536)
  ...
  # [ImGui::DragFloat2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L537)
  ...
  # [ImGui::DragFloat3()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L538)
  ...
  # [ImGui::DragFloat4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L539)
  ...
  # [ImGui::DragFloatRange2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L540)
  ...
  # If v_min >= v_max we have no bound
  #
  # [ImGui::DragInt()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L541)
  ...
  # [ImGui::DragInt2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L542)
  ...
  # [ImGui::DragInt3()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L543)
  ...
  # [ImGui::DragInt4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L544)
  ...
  # [ImGui::DragIntRange2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L545)
  ...
  # [ImGui::DragScalar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L546)
  ...
  {% end %}
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::DragScalarN()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L547)
  ...
  #
  # [ImGui::SliderFloat()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L555)
  ...
  # [ImGui::SliderFloat2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L556)
  ...
  # [ImGui::SliderFloat3()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L557)
  ...
  # [ImGui::SliderFloat4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L558)
  ...
  # [ImGui::SliderAngle()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L559)
  ...
  # [ImGui::SliderInt()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L560)
  ...
  # [ImGui::SliderInt2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L561)
  ...
  # [ImGui::SliderInt3()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L562)
  ...
  # [ImGui::SliderInt4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L563)
  ...
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::SliderScalar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L564)
  ...
  {% end %}
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::SliderScalarN()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L565)
  ...
  {% end %}
  # [ImGui::VSliderFloat()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L566)
  ...
  # [ImGui::VSliderInt()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L567)
  ...
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::VSliderScalar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L568)
  ...
  # [ImGui::InputText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L573)
  ...
  # [ImGui::InputTextMultiline()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L574)
  ...
  # [ImGui::InputTextWithHint()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L575)
  ...
  # [ImGui::InputFloat()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L576)
  ...
  # [ImGui::InputFloat2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L577)
  ...
  # [ImGui::InputFloat3()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L578)
  ...
  # [ImGui::InputFloat4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L579)
  ...
  # [ImGui::InputInt()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L580)
  ...
  # [ImGui::InputInt2()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L581)
  ...
  # [ImGui::InputInt3()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L582)
  ...
  # [ImGui::InputInt4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L583)
  ...
  # [ImGui::InputDouble()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L584)
  ...
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::InputScalar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L585)
  ...
  {% end %}
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::InputScalarN()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L586)
  ...
  {% end %}
  # [ImGui::ColorEdit3()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L591)
  ...
  # [ImGui::ColorEdit4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L592)
  ...
  # [ImGui::ColorPicker3()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L593)
  ...
  # [ImGui::ColorPicker4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L594)
  ...
  #
  # [ImGui::ColorButton()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L595)
  ...
  #
  # [ImGui::SetColorEditOptions()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L596)
  def self.set_color_edit_options(flags : ImGuiColorEditFlags) : Void
    LibImGui.SetColorEditOptions(flags)
  end

  # [ImGui::TreeNode()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L600)
  ...
  #
  # [ImGui::TreeNode()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L601)
  ...
  # "
  #
  # [ImGui::TreeNode()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L602)
  ...
  # [ImGui::TreeNodeEx()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L605)
  ...
  # [ImGui::TreeNodeEx()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L606)
  ...
  # [ImGui::TreeNodeEx()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L607)
  ...
  #
  # [ImGui::TreePush()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L610)
  ...
  # "
  #
  # [ImGui::TreePush()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L611)
  ...
  # ~ Unindent()+PopId()
  #
  # [ImGui::TreePop()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L612)
  ...
  #
  # [ImGui::GetTreeNodeToLabelSpacing()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L613)
  ...
  #
  # [ImGui::CollapsingHeader()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L614)
  ...
  #
  # [ImGui::CollapsingHeader()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L615)
  ...
  #
  # [ImGui::SetNextItemOpen()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L616)
  ...
  #
  # [ImGui::Selectable()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L621)
  ...
  #
  # [ImGui::Selectable()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L622)
  ...
  #
  # [ImGui::BeginListBox()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L630)
  ...
  #
  # [ImGui::EndListBox()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L631)
  def self.end_list_box : Void
    LibImGui.EndListBox
  end

  # [ImGui::ListBox()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L632)
  ...
  # [ImGui::ListBox()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L633)
  ...
  # [ImGui::PlotLines()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L637)
  ...
  # [ImGui::PlotLines()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L638)
  ...
  # [ImGui::PlotHistogram()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L639)
  ...
  # [ImGui::PlotHistogram()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L640)
  ...
  # [ImGui::Value()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L644)
  def self.value(prefix : String, b : Bool) : Void
    LibImGui.Value_Bool(prefix, b)
  end

  # [ImGui::Value()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L645)
  def self.value(prefix : String, v : Int32) : Void
    LibImGui.Value_Int(prefix, v)
  end

  # [ImGui::Value()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L646)
  def self.value(prefix : String, v : UInt32) : Void
    LibImGui.Value_Uint(prefix, v)
  end

  # [ImGui::Value()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L647)
  ...
  #
  # [ImGui::BeginMenuBar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L654)
  ...
  #
  # [ImGui::EndMenuBar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L655)
  ...
  #
  # [ImGui::BeginMainMenuBar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L656)
  ...
  #
  # [ImGui::EndMainMenuBar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L657)
  ...
  #
  # [ImGui::BeginMenu()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L658)
  ...
  #
  # [ImGui::EndMenu()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L659)
  ...
  #
  # [ImGui::MenuItem()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L660)
  ...
  #
  # [ImGui::MenuItem()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L661)
  ...
  #
  # [ImGui::BeginTooltip()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L665)
  def self.begin_tooltip : Void
    LibImGui.BeginTooltip
  end

  # [ImGui::EndTooltip()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L666)
  ...
  #
  # [ImGui::SetTooltip()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L667)
  ...
  #
  # [ImGui::BeginPopup()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L682)
  ...
  #
  # [ImGui::BeginPopupModal()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L683)
  ...
  #
  # [ImGui::EndPopup()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L684)
  ...
  #
  # [ImGui::OpenPopup()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L693)
  ...
  #
  # [ImGui::OpenPopup()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L694)
  ...
  #
  # [ImGui::OpenPopupOnItemClick()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L695)
  ...
  #
  # [ImGui::CloseCurrentPopup()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L696)
  ...
  #
  # [ImGui::BeginPopupContextItem()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L703)
  ...
  #
  # [ImGui::BeginPopupContextWindow()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L704)
  ...
  #
  # [ImGui::BeginPopupContextVoid()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L705)
  ...
  #
  # [ImGui::IsPopupOpen()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L711)
  ...
  # [ImGui::BeginTable()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L738)
  ...
  #
  # [ImGui::EndTable()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L739)
  ...
  #
  # [ImGui::TableNextRow()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L740)
  ...
  #
  # [ImGui::TableNextColumn()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L741)
  ...
  #
  # [ImGui::TableSetColumnIndex()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L742)
  def self.table_set_column_index(column_n : Int32) : Bool
    LibImGui.TableSetColumnIndex(column_n)
  end

  # [ImGui::TableSetupColumn()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L752)
  ...
  #
  # [ImGui::TableSetupScrollFreeze()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L753)
  ...
  #
  # [ImGui::TableHeadersRow()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L754)
  ...
  #
  # [ImGui::TableHeader()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L755)
  ...
  #
  # [ImGui::TableGetSortSpecs()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L763)
  ...
  #
  # [ImGui::TableGetColumnCount()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L767)
  ...
  #
  # [ImGui::TableGetColumnIndex()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L768)
  ...
  #
  # [ImGui::TableGetRowIndex()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L769)
  ...
  #
  # [ImGui::TableGetColumnName()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L770)
  ...
  #
  # [ImGui::TableGetColumnFlags()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L771)
  ...
  #
  # [ImGui::TableSetColumnEnabled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L772)
  ...
  #
  # [ImGui::TableSetBgColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L773)
  ...
  # [ImGui::Columns()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L777)
  ...
  #
  # [ImGui::NextColumn()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L778)
  ...
  #
  # [ImGui::GetColumnIndex()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L779)
  ...
  #
  # [ImGui::GetColumnWidth()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L780)
  ...
  #
  # [ImGui::SetColumnWidth()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L781)
  ...
  #
  # [ImGui::GetColumnOffset()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L782)
  ...
  #
  # [ImGui::SetColumnOffset()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L783)
  def self.set_column_offset(column_index : Int32, offset_x : Float32) : Void
    LibImGui.SetColumnOffset(column_index, offset_x)
  end

  # [ImGui::GetColumnsCount()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L784)
  ...
  #
  # [ImGui::BeginTabBar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L787)
  ...
  #
  # [ImGui::EndTabBar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L788)
  ...
  #
  # [ImGui::BeginTabItem()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L789)
  ...
  #
  # [ImGui::EndTabItem()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L790)
  ...
  #
  # [ImGui::TabItemButton()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L791)
  ...
  #
  # [ImGui::SetTabItemClosed()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L792)
  ...
  #
  # [ImGui::LogToTTY()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L796)
  ...
  #
  # [ImGui::LogToFile()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L797)
  ...
  #
  # [ImGui::LogToClipboard()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L798)
  ...
  #
  # [ImGui::LogFinish()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L799)
  ...
  #
  # [ImGui::LogButtons()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L800)
  ...
  #
  # [ImGui::LogText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L801)
  ...
  #
  # [ImGui::BeginDragDropSource()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L809)
  ...
  #
  # [ImGui::SetDragDropPayload()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L810)
  ...
  #
  # [ImGui::EndDragDropSource()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L811)
  ...
  #
  # [ImGui::BeginDragDropTarget()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L812)
  ...
  #
  # [ImGui::AcceptDragDropPayload()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L813)
  ...
  #
  # [ImGui::EndDragDropTarget()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L814)
  ...
  #
  # [ImGui::GetDragDropPayload()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L815)
  def self.get_drag_drop_payload : ImGuiPayload?
    result = LibImGui.GetDragDropPayload
    result ? ImGuiPayload.new(result) : nil
  end

  # [ImGui::BeginDisabled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L821)
  def self.begin_disabled(disabled : Bool = true) : Void
    LibImGui.BeginDisabled(disabled)
  end

  # [ImGui::EndDisabled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L822)
  def self.end_disabled : Void
    LibImGui.EndDisabled
  end

  # [ImGui::PushClipRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L826)
  ...
  # [ImGui::PopClipRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L827)
  ...
  #
  # [ImGui::SetItemDefaultFocus()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L831)
  ...
  #
  # [ImGui::SetKeyboardFocusHere()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L832)
  ...
  #
  # [ImGui::IsItemHovered()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L837)
  ...
  #
  # [ImGui::IsItemActive()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L838)
  ...
  #
  # [ImGui::IsItemFocused()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L839)
  ...
  #
  # [ImGui::IsItemClicked()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L840)
  ...
  #
  # [ImGui::IsItemVisible()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L841)
  ...
  #
  # [ImGui::IsItemEdited()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L842)
  ...
  #
  # [ImGui::IsItemActivated()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L843)
  ...
  #
  # [ImGui::IsItemDeactivated()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L844)
  ...
  #
  # [ImGui::IsItemDeactivatedAfterEdit()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L845)
  ...
  #
  # [ImGui::IsItemToggledOpen()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L846)
  ...
  # is any item hovered?
  #
  # [ImGui::IsAnyItemHovered()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L847)
  ...
  # is any item active?
  #
  # [ImGui::IsAnyItemActive()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L848)
  ...
  # is any item focused?
  #
  # [ImGui::IsAnyItemFocused()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L849)
  ...
  #
  # [ImGui::GetItemRectMin()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L850)
  ...
  #
  # [ImGui::GetItemRectMax()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L851)
  ...
  #
  # [ImGui::GetItemRectSize()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L852)
  ...
  #
  # [ImGui::SetItemAllowOverlap()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L853)
  ...
  #
  # [ImGui::GetMainViewport()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L859)
  ...
  #
  # [ImGui::IsRectVisible()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L862)
  ...
  #
  # [ImGui::IsRectVisible()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L863)
  ...
  #
  # [ImGui::GetTime()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L864)
  ...
  #
  # [ImGui::GetFrameCount()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L865)
  ...
  #
  # [ImGui::GetBackgroundDrawList()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L866)
  ...
  #
  # [ImGui::GetForegroundDrawList()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L867)
  ...
  #
  # [ImGui::GetDrawListSharedData()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L868)
  ...
  #
  # [ImGui::GetStyleColorName()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L869)
  ...
  #
  # [ImGui::SetStateStorage()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L870)
  def self.set_state_storage(storage : ImGuiStorage*) : Void
    LibImGui.SetStateStorage(storage)
  end

  # [ImGui::GetStateStorage()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L871)
  ...
  #
  # [ImGui::BeginChildFrame()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L872)
  ...
  #
  # [ImGui::EndChildFrame()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L873)
  def self.end_child_frame : Void
    LibImGui.EndChildFrame
  end

  # [ImGui::CalcTextSize()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L876)
  ...
  # [ImGui::ColorConvertU32ToFloat4()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L879)
  def self.color_convert_u32_to_float4(in_ : UInt32) : ImGui::ImVec4
    LibImGui.ColorConvertU32ToFloat4(out p_out, in_)
    p_out
  end

  # [ImGui::ColorConvertFloat4ToU32()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L880)
  def self.color_convert_float4_to_u32(in_ : ImVec4) : UInt32
    LibImGui.ColorConvertFloat4ToU32(in_)
  end

  # [ImGui::ColorConvertRGBtoHSV()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L881)
  ...
  # [ImGui::ColorConvertHSVtoRGB()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L882)
  ...
  #
  # [ImGui::GetKeyIndex()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L887)
  ...
  #
  # [ImGui::IsKeyDown()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L888)
  ...
  #
  # [ImGui::IsKeyPressed()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L889)
  ...
  #
  # [ImGui::IsKeyReleased()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L890)
  ...
  #
  # [ImGui::GetKeyPressedAmount()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L891)
  ...
  #
  # [ImGui::CaptureKeyboardFromApp()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L892)
  ...
  #
  # [ImGui::IsMouseDown()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L898)
  ...
  #
  # [ImGui::IsMouseClicked()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L899)
  ...
  #
  # [ImGui::IsMouseReleased()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L900)
  ...
  #
  # [ImGui::IsMouseDoubleClicked()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L901)
  ...
  #
  # [ImGui::GetMouseClickedCount()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L902)
  ...
  #
  # [ImGui::IsMouseHoveringRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L903)
  ...
  #
  # [ImGui::IsMousePosValid()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L904)
  ...
  #
  # [ImGui::IsAnyMouseDown()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L905)
  ...
  #
  # [ImGui::GetMousePos()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L906)
  ...
  #
  # [ImGui::GetMousePosOnOpeningCurrentPopup()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L907)
  ...
  #
  # [ImGui::IsMouseDragging()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L908)
  ...
  #
  # [ImGui::GetMouseDragDelta()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L909)
  ...
  # [ImGui::ResetMouseDragDelta()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L910)
  ...
  #
  # [ImGui::GetMouseCursor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L911)
  ...
  #
  # [ImGui::SetMouseCursor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L912)
  ...
  #
  # [ImGui::CaptureMouseFromApp()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L913)
  ...
  # [ImGui::GetClipboardText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L917)
  def self.get_clipboard_text : String
    result = LibImGui.GetClipboardText
    String.new(result)
  end

  # [ImGui::SetClipboardText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L918)
  ...
  #
  # [ImGui::LoadIniSettingsFromDisk()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L924)
  ...
  #
  # [ImGui::LoadIniSettingsFromMemory()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L925)
  ...
  #
  # [ImGui::SaveIniSettingsToDisk()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L926)
  ...
  #
  # [ImGui::SaveIniSettingsToMemory()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L927)
  ...
  #
  # [ImGui::DebugCheckVersionAndDataLayout()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L931)
  ...
  # [ImGui::SetAllocatorFunctions()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L937)
  ...
  # [ImGui::GetAllocatorFunctions()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L938)
  ...
  # [ImGui::MemAlloc()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L939)
  def self.mem_alloc(size : LibC::SizeT) : Void*
    LibImGui.MemAlloc(size)
  end

  # [ImGui::MemFree()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L940)
  def self.mem_free(ptr : Void*) : Void
    LibImGui.MemFree(ptr)
  end

  # [struct ImVector](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1695)
  struct ImVector
    include StructType
  end

  # [struct ImGuiStyle](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1765)
  struct ImGuiStyle
    ...
    # [ImGuiStyle::ImGuiStyle()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1809)
    def self.new : ImGuiStyle
      result = LibImGui.ImGuiStyle_ImGuiStyle
      ImGuiStyle.new(result)
    end

    # [ImGuiStyle::ScaleAllSizes()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1810)
  ...
  # [struct ImGuiIO](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1820)
  struct ImGuiIO
    ...
    #
    # [ImGuiIO::AddInputCharacter()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1895)
    ...
    #
    # [ImGuiIO::AddInputCharacterUTF16()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1896)
    ...
    #
    # [ImGuiIO::AddInputCharactersUTF8()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1897)
    ...
    #
    # [ImGuiIO::AddFocusEvent()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1898)
    ...
    #
    # [ImGuiIO::ClearInputCharacters()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1899)
    ...
    #
    # [ImGuiIO::ClearInputKeys()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1900)
    def clear_input_keys : Void
      LibImGui.ImGuiIO_ClearInputKeys(self)
    end

    # [ImGuiIO::ImGuiIO()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1953)
  ...
  # [struct ImGuiInputTextCallbackData](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1969)
  struct ImGuiInputTextCallbackData
    ...
    # [ImGuiInputTextCallbackData::ImGuiInputTextCallbackData()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1990)
    ...
    # [ImGuiInputTextCallbackData::DeleteChars()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1991)
    def delete_chars(pos : Int32, bytes_count : Int32) : Void
      LibImGui.ImGuiInputTextCallbackData_DeleteChars(self, pos, bytes_count)
    end

    # [ImGuiInputTextCallbackData::InsertChars()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1992)
    ...
    # [ImGuiInputTextCallbackData::SelectAll()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1993)
    def select_all : Void
      LibImGui.ImGuiInputTextCallbackData_SelectAll(self)
    end

    # [ImGuiInputTextCallbackData::ClearSelection()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1994)
    def clear_selection : Void
      LibImGui.ImGuiInputTextCallbackData_ClearSelection(self)
    end

    # [ImGuiInputTextCallbackData::HasSelection()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L1995)
  ...
  # [struct ImGuiSizeCallbackData](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2000)
  ...
  # [struct ImGuiPayload](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2009)
  struct ImGuiPayload
    ...
    # [ImGuiPayload::ImGuiPayload()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2023)
    def self.new : ImGuiPayload
      result = LibImGui.ImGuiPayload_ImGuiPayload
      ImGuiPayload.new(result)
    end

    # [ImGuiPayload::Clear()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2024)
    def clear : Void
      LibImGui.ImGuiPayload_Clear(self)
    end

    # [ImGuiPayload::IsDataType()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2025)
    def is_data_type(type : String) : Bool
      LibImGui.ImGuiPayload_IsDataType(self, type)
    end

    # [ImGuiPayload::IsPreview()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2026)
    def is_preview : Bool
      LibImGui.ImGuiPayload_IsPreview(self)
    end

    # [ImGuiPayload::IsDelivery()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2027)
  ...
  # [struct ImGuiTableColumnSortSpecs](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2031)
  struct ImGuiTableColumnSortSpecs
    ...
    # [ImGuiTableColumnSortSpecs::ImGuiTableColumnSortSpecs()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2038)
  ...
  # [struct ImGuiTableSortSpecs](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2045)
  struct ImGuiTableSortSpecs
    ...
    # [ImGuiTableSortSpecs::ImGuiTableSortSpecs()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2051)
  ...
  # [struct ImGuiOnceUponAFrame](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2068)
  struct ImGuiOnceUponAFrame
    include StructType

    # [ImGuiOnceUponAFrame::ImGuiOnceUponAFrame()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2070)
  ...
  # [struct ImGuiTextFilter](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2076)
  struct ImGuiTextFilter
    ...
    # [ImGuiTextFilter::ImGuiTextFilter()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2078)
    ...
    #
    # [ImGuiTextFilter::Draw()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2079)
    def draw(label : String = "Filter(inc,-exc)", width : Float32 = 0.0) : Bool
      LibImGui.ImGuiTextFilter_Draw(self, label, width)
    end

    # [ImGuiTextFilter::PassFilter()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2080)
    def pass_filter(text : Bytes | String) : Bool
      LibImGui.ImGuiTextFilter_PassFilter(self, text, (text.to_unsafe + text.bytesize))
    end

    # [ImGuiTextFilter::Build()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2081)
    def build : Void
      LibImGui.ImGuiTextFilter_Build(self)
    end

    # [ImGuiTextFilter::Clear()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2082)
    def clear : Void
      LibImGui.ImGuiTextFilter_Clear(self)
    end

    # [ImGuiTextFilter::IsActive()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2083)
    def is_active : Bool
  ...
  # [struct ImGuiStorage](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2130)
  struct ImGuiStorage
    include StructType
    ...
    # [ImGuiStorage::Clear()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2147)
    def clear : Void
      LibImGui.ImGuiStorage_Clear(self)
    end

    # [ImGuiStorage::GetInt()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2148)
    def get_int(key : ImGuiID, default_val : Int32 = 0) : Int32
      LibImGui.ImGuiStorage_GetInt(self, key, default_val)
    end

    # [ImGuiStorage::SetInt()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2149)
    def set_int(key : ImGuiID, val : Int32) : Void
      LibImGui.ImGuiStorage_SetInt(self, key, val)
    end

    # [ImGuiStorage::GetBool()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2150)
    def get_bool(key : ImGuiID, default_val : Bool = false) : Bool
      LibImGui.ImGuiStorage_GetBool(self, key, default_val)
    end

    # [ImGuiStorage::SetBool()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2151)
    def set_bool(key : ImGuiID, val : Bool) : Void
      LibImGui.ImGuiStorage_SetBool(self, key, val)
    end

    # [ImGuiStorage::GetFloat()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2152)
    def get_float(key : ImGuiID, default_val : Float32 = 0.0) : Float32
      LibImGui.ImGuiStorage_GetFloat(self, key, default_val)
    end

    # [ImGuiStorage::SetFloat()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2153)
    ...
    # [ImGuiStorage::SetAllInt()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2167)
    def set_all_int(val : Int32) : Void
      LibImGui.ImGuiStorage_SetAllInt(self, val)
    end

    # [ImGuiStorage::BuildSortByKey()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2170)
    def build_sort_by_key : Void
      LibImGui.ImGuiStorage_BuildSortByKey(self)
    end
  end

  # [struct ImGuiListClipper](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2193)
  struct ImGuiListClipper
    include StructType

    # [ImGuiListClipper::ImGuiListClipper()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2204)
    def self.new : ImGuiListClipper
      result = LibImGui.ImGuiListClipper_ImGuiListClipper
      result.value
    end

    # [ImGuiListClipper::Begin()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2206)
    ...
    #
    # [ImGuiListClipper::End()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2207)
    def end : Void
    ...
    #
    # [ImGuiListClipper::Step()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2208)
    def step : Bool
    ...
    #
    # [ImGuiListClipper::ForceDisplayRangeByIndices()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2211)
  ...
  # [struct ImColor](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2241)
  struct ImColor
    include StructType

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2245)
    def self.new : ImColor
      result = LibImGui.ImColor_ImColor_Nil
      result.value
    end

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2246)
    def self.new(r : Int32, g : Int32, b : Int32, a : Int32 = 255) : ImColor
      result = LibImGui.ImColor_ImColor_Int(r, g, b, a)
      result.value
    end

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2247)
    def self.new(rgba : UInt32) : ImColor
      result = LibImGui.ImColor_ImColor_U32(rgba)
      result.value
    end

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2248)
    def self.new(r : Float32, g : Float32, b : Float32, a : Float32 = 1.0) : ImColor
      result = LibImGui.ImColor_ImColor_Float(r, g, b, a)
      result.value
    end

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2249)
    def self.new(col : ImVec4) : ImColor
      result = LibImGui.ImColor_ImColor_Vec4(col)
      result.value
    end

    # [ImColor::SetHSV()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2254)
    def set_hsv(h : Float32, s : Float32, v : Float32, a : Float32 = 1.0) : Void
      LibImGui.ImColor_SetHSV(self, h, s, v, a)
    end

    # [ImColor::HSV()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2255)
  ...
  # [struct ImDrawCmd](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2290)
  struct ImDrawCmd
    ...
    #
    # [ImDrawCmd::ImDrawCmd()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2300)
    def self.new : ImDrawCmd
      result = LibImGui.ImDrawCmd_ImDrawCmd
      ImDrawCmd.new(result)
    end

    # [ImDrawCmd::GetTexID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2303)
  ...
  # [struct ImDrawVert](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2308)
  struct ImDrawVert
    include StructType
  end

  # [struct ImDrawCmdHeader](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2323)
  ...
  # [struct ImDrawChannel](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2331)
  struct ImDrawChannel
    include StructType
  end

  # [struct ImDrawListSplitter](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2340)
  struct ImDrawListSplitter
    include ClassType(LibImGui::ImDrawListSplitter)

    # [ImDrawListSplitter::ImDrawListSplitter()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2346)
    ...
    #
    # [ImDrawListSplitter::Clear()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2348)
    def clear : Void
      LibImGui.ImDrawListSplitter_Clear(self)
    end

    # [ImDrawListSplitter::ClearFreeMemory()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2349)
    def clear_free_memory : Void
      LibImGui.ImDrawListSplitter_ClearFreeMemory(self)
    end

    # [ImDrawListSplitter::Split()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2350)
    def split(draw_list : ImDrawList, count : Int32) : Void
      LibImGui.ImDrawListSplitter_Split(self, draw_list, count)
    end

    # [ImDrawListSplitter::Merge()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2351)
    def merge(draw_list : ImDrawList) : Void
      LibImGui.ImDrawListSplitter_Merge(self, draw_list)
    end

    # [ImDrawListSplitter::SetCurrentChannel()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2352)
  ...
  # [struct ImDrawList](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2395)
  struct ImDrawList
    ...
    # [ImDrawList::ImDrawList()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2417)
    ...
    #
    # [ImDrawList::PushClipRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2420)
    ...
    # [ImDrawList::PushClipRectFullScreen()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2421)
    def push_clip_rect_full_screen : Void
      LibImGui.ImDrawList_PushClipRectFullScreen(self)
    end

    # [ImDrawList::PopClipRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2422)
    def pop_clip_rect : Void
      LibImGui.ImDrawList_PopClipRect(self)
    end

    # [ImDrawList::PushTextureID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2423)
    def push_texture_id(texture_id : ImTextureID) : Void
      LibImGui.ImDrawList_PushTextureID(self, texture_id)
    end

    # [ImDrawList::PopTextureID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2424)
    def pop_texture_id : Void
      LibImGui.ImDrawList_PopTextureID(self)
    end

    # [ImDrawList::GetClipRectMin()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2425)
    def get_clip_rect_min : ImGui::ImVec2
      LibImGui.ImDrawList_GetClipRectMin(out p_out, self)
      p_out
    end

    # [ImDrawList::GetClipRectMax()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2426)
    def get_clip_rect_max : ImGui::ImVec2
      LibImGui.ImDrawList_GetClipRectMax(out p_out, self)
      p_out
    end

    # [ImDrawList::AddLine()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2434)
    ...
    #
    # [ImDrawList::AddRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2435)
    ...
    # a: upper-left, b: lower-right (== upper-left + size)
    #
    # [ImDrawList::AddRectFilled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2436)
    ...
    # [ImDrawList::AddRectFilledMultiColor()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2437)
    ...
    # [ImDrawList::AddQuad()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2438)
    ...
    # [ImDrawList::AddQuadFilled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2439)
    ...
    # [ImDrawList::AddTriangle()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2440)
    ...
    # [ImDrawList::AddTriangleFilled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2441)
    ...
    # [ImDrawList::AddCircle()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2442)
    ...
    # [ImDrawList::AddCircleFilled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2443)
    ...
    # [ImDrawList::AddNgon()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2444)
    ...
    # [ImDrawList::AddNgonFilled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2445)
    ...
    # [ImDrawList::AddText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2446)
    ...
    # [ImDrawList::AddText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2447)
    ...
    # [ImDrawList::AddPolyline()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2448)
    ...
    #
    # [ImDrawList::AddConvexPolyFilled()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2449)
    ...
    #
    # [ImDrawList::AddBezierCubic()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2450)
    ...
    #
    # [ImDrawList::AddBezierQuadratic()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2451)
    ...
    # [ImDrawList::AddImage()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2457)
    ...
    # [ImDrawList::AddImageQuad()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2458)
    ...
    # [ImDrawList::AddImageRounded()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2459)
    ...
    # [ImDrawList::PathClear()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2462)
    def path_clear : Void
      LibImGui.ImDrawList_PathClear(self)
    end

    # [ImDrawList::PathLineTo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2463)
    def path_line_to(pos : ImVec2) : Void
      LibImGui.ImDrawList_PathLineTo(self, pos)
    end

    # [ImDrawList::PathLineToMergeDuplicate()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2464)
    ...
    # Note: Anti-aliased filling requires points to be in clockwise order.
    #
    # [ImDrawList::PathFillConvex()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2465)
    def path_fill_convex(col : UInt32) : Void
      LibImGui.ImDrawList_PathFillConvex(self, col)
    end

    # [ImDrawList::PathStroke()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2466)
    ...
    # [ImDrawList::PathArcTo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2467)
    ...
    #
    # [ImDrawList::PathArcToFast()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2468)
    ...
    # Cubic Bezier (4 control points)
    #
    # [ImDrawList::PathBezierCubicCurveTo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2469)
    ...
    # Quadratic Bezier (3 control points)
    #
    # [ImDrawList::PathBezierQuadraticCurveTo()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2470)
    ...
    # [ImDrawList::PathRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2471)
    ...
    #
    # [ImDrawList::AddCallback()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2474)
    ...
    #
    # [ImDrawList::AddDrawCmd()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2475)
    ...
    #
    # [ImDrawList::CloneOutput()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2476)
    def clone_output : ImDrawList
      result = LibImGui.ImDrawList_CloneOutput(self)
      ImDrawList.new(result)
    end

    # [ImDrawList::ChannelsSplit()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2484)
    def channels_split(count : Int32) : Void
      LibImGui.ImDrawList_ChannelsSplit(self, count)
    end

    # [ImDrawList::ChannelsMerge()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2485)
    def channels_merge : Void
      LibImGui.ImDrawList_ChannelsMerge(self)
    end

    # [ImDrawList::ChannelsSetCurrent()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2486)
    def channels_set_current(n : Int32) : Void
      LibImGui.ImDrawList_ChannelsSetCurrent(self, n)
    end

    # [ImDrawList::PrimReserve()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2491)
    def prim_reserve(idx_count : Int32, vtx_count : Int32) : Void
      LibImGui.ImDrawList_PrimReserve(self, idx_count, vtx_count)
    end

    # [ImDrawList::PrimUnreserve()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2492)
    ...
    #
    # [ImDrawList::PrimRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2493)
    def prim_rect(a : ImVec2, b : ImVec2, col : UInt32) : Void
      LibImGui.ImDrawList_PrimRect(self, a, b, col)
    end

    # [ImDrawList::PrimRectUV()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2494)
    ...
    # [ImDrawList::PrimQuadUV()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2495)
    ...
    # [ImDrawList::PrimWriteVtx()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2496)
    def prim_write_vtx(pos : ImVec2, uv : ImVec2, col : UInt32) : Void
      LibImGui.ImDrawList_PrimWriteVtx(self, pos, uv, col)
    end

    # [ImDrawList::PrimWriteIdx()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2497)
    ...
    #
    # [ImDrawList::PrimVtx()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2498)
  ...
  # [struct ImDrawData](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2521)
  struct ImDrawData
    ...
    # [ImDrawData::ImDrawData()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2533)
    ...
    #
    # [ImDrawData::Clear()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2534)
    def clear : Void
    ...
    #
    # [ImDrawData::DeIndexAllBuffers()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2535)
    ...
    #
    # [ImDrawData::ScaleClipRects()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2536)
  ...
  # [struct ImFontConfig](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2543)
  struct ImFontConfig
    ...
    # [ImFontConfig::ImFontConfig()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2567)
  ...
  # [struct ImFontGlyph](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2572)
  struct ImFontGlyph
    include StructType
  end

  # [struct ImFontGlyphRangesBuilder](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2584)
  struct ImFontGlyphRangesBuilder
    ...
    # [ImFontGlyphRangesBuilder::ImFontGlyphRangesBuilder()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2588)
    def self.new : ImFontGlyphRangesBuilder
      result = LibImGui.ImFontGlyphRangesBuilder_ImFontGlyphRangesBuilder
      result.value
    end

    # [ImFontGlyphRangesBuilder::Clear()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2589)
    def clear : Void
    ...
    #
    # [ImFontGlyphRangesBuilder::GetBit()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2590)
    ...
    #
    # [ImFontGlyphRangesBuilder::SetBit()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2591)
    ...
    # Add character
    #
    # [ImFontGlyphRangesBuilder::AddChar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2592)
    ...
    #
    # [ImFontGlyphRangesBuilder::AddText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2593)
    ...
    #
    # [ImFontGlyphRangesBuilder::AddRanges()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2594)
    ...
    # Output new ranges
    #
    # [ImFontGlyphRangesBuilder::BuildRanges()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2595)
  ...
  # [struct ImFontAtlasCustomRect](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2599)
  struct ImFontAtlasCustomRect
    ...
    # [ImFontAtlasCustomRect::ImFontAtlasCustomRect()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2607)
    ...
    # [ImFontAtlasCustomRect::IsPacked()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2608)
    def is_packed : Bool
  ...
  # [struct ImFontAtlas](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2637)
  struct ImFontAtlas
    ...
    # [ImFontAtlas::ImFontAtlas()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2639)
    def self.new : ImFontAtlas
      result = LibImGui.ImFontAtlas_ImFontAtlas
      ImFontAtlas.new(result)
    end

    # [ImFontAtlas::AddFont()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2641)
    def add_font(font_cfg : ImFontConfig) : ImFont
      result = LibImGui.ImFontAtlas_AddFont(self, font_cfg)
      ImFont.new(result)
    end

    # [ImFontAtlas::AddFontDefault()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2642)
    def add_font_default(font_cfg : ImFontConfig? = nil) : ImFont
      result = LibImGui.ImFontAtlas_AddFontDefault(self, font_cfg)
      ImFont.new(result)
    end

    # [ImFontAtlas::AddFontFromFileTTF()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2643)
    ...
    #
    # [ImFontAtlas::AddFontFromMemoryTTF()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2644)
    ...
    #
    # [ImFontAtlas::AddFontFromMemoryCompressedTTF()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2645)
    ...
    #
    # [ImFontAtlas::AddFontFromMemoryCompressedBase85TTF()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2646)
    ...
    #
    # [ImFontAtlas::ClearInputData()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2647)
    ...
    #
    # [ImFontAtlas::ClearTexData()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2648)
    ...
    #
    # [ImFontAtlas::ClearFonts()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2649)
    ...
    #
    # [ImFontAtlas::Clear()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2650)
    def clear : Void
    ...
    #
    # [ImFontAtlas::Build()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2657)
    def build : Bool
    ...
    # 1 byte per-pixel
    #
    # [ImFontAtlas::GetTexDataAsAlpha8()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2658)
    ...
    # 4 bytes-per-pixel
    #
    # [ImFontAtlas::GetTexDataAsRGBA32()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2659)
    ...
    #
    # [ImFontAtlas::IsBuilt()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2660)
    def is_built : Bool
      LibImGui.ImFontAtlas_IsBuilt(self)
    end

    # [ImFontAtlas::SetTexID()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2661)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesDefault()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2670)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesKorean()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2671)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesJapanese()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2672)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesChineseFull()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2673)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesChineseSimplifiedCommon()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2674)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesCyrillic()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2675)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesThai()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2676)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesVietnamese()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2677)
    def get_glyph_ranges_vietnamese : ImWchar*
      LibImGui.ImFontAtlas_GetGlyphRangesVietnamese(self)
    end

    # [ImFontAtlas::AddCustomRectRegular()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2690)
    def add_custom_rect_regular(width : Int32, height : Int32) : Int32
      LibImGui.ImFontAtlas_AddCustomRectRegular(self, width, height)
    end

    # [ImFontAtlas::AddCustomRectFontGlyph()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2691)
    ...
    # [ImFontAtlas::GetCustomRectByIndex()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2692)
    ...
    # [ImFontAtlas::CalcCustomRectUV()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2695)
    ...
    # [ImFontAtlas::GetMouseCursorTexData()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2696)
  ...
  # [struct ImFont](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2739)
  struct ImFont
    ...
    # [ImFont::ImFont()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2765)
    def self.new : ImFont
      result = LibImGui.ImFont_ImFont
      ImFont.new(result)
    end

    # [ImFont::FindGlyph()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2767)
    def find_glyph(c : ImWchar) : ImFontGlyph
      result = LibImGui.ImFont_FindGlyph(self, c)
      result.value
    end

    # [ImFont::FindGlyphNoFallback()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2768)
    def find_glyph_no_fallback(c : ImWchar) : ImFontGlyph
      result = LibImGui.ImFont_FindGlyphNoFallback(self, c)
      result.value
    end

    # [ImFont::GetCharAdvance()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2769)
    def get_char_advance(c : ImWchar) : Float32
      LibImGui.ImFont_GetCharAdvance(self, c)
    end

    # [ImFont::IsLoaded()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2770)
    def is_loaded : Bool
      LibImGui.ImFont_IsLoaded(self)
    end

    # [ImFont::GetDebugName()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2771)
    ...
    # utf8
    #
    # [ImFont::CalcTextSizeA()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2775)
    ...
    # [ImFont::CalcWordWrapPositionA()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2776)
    ...
    # [ImFont::RenderChar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2777)
    ...
    # [ImFont::RenderText()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2778)
    ...
    # [ImFont::BuildLookupTable()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2781)
    def build_lookup_table : Void
      LibImGui.ImFont_BuildLookupTable(self)
    end

    # [ImFont::ClearOutputData()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2782)
    def clear_output_data : Void
      LibImGui.ImFont_ClearOutputData(self)
    end

    # [ImFont::GrowIndex()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2783)
    def grow_index(new_size : Int32) : Void
      LibImGui.ImFont_GrowIndex(self, new_size)
    end

    # [ImFont::AddGlyph()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2784)
    ...
    #
    # [ImFont::AddRemapChar()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2785)
    ...
    # [ImFont::SetGlyphVisible()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2786)
    def set_glyph_visible(c : ImWchar, visible : Bool) : Void
      LibImGui.ImFont_SetGlyphVisible(self, c, visible)
    end

    # [ImFont::IsGlyphRangeUnused()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2787)
  ...
  # [struct ImGuiViewport](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2810)
  struct ImGuiViewport
    ...
    # [ImGuiViewport::ImGuiViewport()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2818)
    def self.new : ImGuiViewport
      result = LibImGui.ImGuiViewport_ImGuiViewport
      ImGuiViewport.new(result)
    end

    # [ImGuiViewport::GetCenter()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2821)
    def get_center : ImGui::ImVec2
      LibImGui.ImGuiViewport_GetCenter(out p_out, self)
      p_out
    end

    # [ImGuiViewport::GetWorkCenter()](https://github.com/ocornut/imgui/blob/v1.86/imgui.h#L2822)
