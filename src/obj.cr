...
module ImGui
  # [struct ImVec2](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L249)
  struct ImVec2
    include StructType

    # [ImVec2::ImVec2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L252)
    def self.new : ImVec2
      result = LibImGui.ImVec2_ImVec2_Nil
      result.value
    end

    # [ImVec2::ImVec2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L253)
  ...
  # [struct ImVec4](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L262)
  struct ImVec4
    include StructType

    # [ImVec4::ImVec4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L265)
    def self.new : ImVec4
      result = LibImGui.ImVec4_ImVec4_Nil
      result.value
    end

    # [ImVec4::ImVec4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L266)
  ...
  # [ImGui::CreateContext()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L284)
  ...
  #
  # [ImGui::DestroyContext()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L285)
  def self.destroy_context(ctx : ImGuiContext? = nil) : Void
    LibImGui.DestroyContext(ctx)
  end

  # [ImGui::GetCurrentContext()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L286)
  def self.get_current_context : ImGuiContext
    result = LibImGui.GetCurrentContext
    result.value
  end

  # [ImGui::SetCurrentContext()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L287)
  ...
  #
  # [ImGui::GetIO()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L290)
  ...
  #
  # [ImGui::GetStyle()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L291)
  ...
  #
  # [ImGui::NewFrame()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L292)
  ...
  #
  # [ImGui::EndFrame()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L293)
  ...
  #
  # [ImGui::Render()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L294)
  ...
  #
  # [ImGui::GetDrawData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L295)
  ...
  #
  # [ImGui::ShowDemoWindow()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L298)
  ...
  #
  # [ImGui::ShowMetricsWindow()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L299)
  ...
  #
  # [ImGui::ShowStackToolWindow()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L300)
  ...
  #
  # [ImGui::ShowAboutWindow()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L301)
  ...
  #
  # [ImGui::ShowStyleEditor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L302)
  ...
  #
  # [ImGui::ShowStyleSelector()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L303)
  ...
  #
  # [ImGui::ShowFontSelector()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L304)
  ...
  #
  # [ImGui::ShowUserGuide()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L305)
  ...
  #
  # [ImGui::GetVersion()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L306)
  ...
  #
  # [ImGui::StyleColorsDark()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L309)
  ...
  #
  # [ImGui::StyleColorsLight()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L310)
  ...
  # classic imgui style
  #
  # [ImGui::StyleColorsClassic()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L311)
  def self.style_colors_classic(dst : ImGuiStyle? = nil) : Void
    LibImGui.StyleColorsClassic(dst)
  end

  # [ImGui::Begin()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L325)
  ...
  # [ImGui::End()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L326)
  def self.end : Void
    LibImGui.End
  end

  # [ImGui::BeginChild()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L336)
  ...
  # [ImGui::BeginChild()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L337)
  ...
  # [ImGui::EndChild()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L338)
  def self.end_child : Void
    LibImGui.EndChild
  end

  # [ImGui::IsWindowAppearing()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L342)
  def self.is_window_appearing : Bool
    LibImGui.IsWindowAppearing
  end

  # [ImGui::IsWindowCollapsed()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L343)
  ...
  #
  # [ImGui::IsWindowFocused()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L344)
  ...
  #
  # [ImGui::IsWindowHovered()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L345)
  ...
  #
  # [ImGui::GetWindowDrawList()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L346)
  ...
  #
  # [ImGui::GetWindowPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L347)
  ...
  #
  # [ImGui::GetWindowSize()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L348)
  ...
  #
  # [ImGui::GetWindowWidth()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L349)
  ...
  #
  # [ImGui::GetWindowHeight()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L350)
  ...
  #
  # [ImGui::SetNextWindowPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L354)
  ...
  #
  # [ImGui::SetNextWindowSize()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L355)
  ...
  #
  # [ImGui::SetNextWindowSizeConstraints()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L356)
  ...
  #
  # [ImGui::SetNextWindowContentSize()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L357)
  ...
  #
  # [ImGui::SetNextWindowCollapsed()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L358)
  ...
  #
  # [ImGui::SetNextWindowFocus()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L359)
  ...
  #
  # [ImGui::SetNextWindowBgAlpha()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L360)
  ...
  #
  # [ImGui::SetWindowPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L361)
  ...
  #
  # [ImGui::SetWindowPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L366)
  ...
  #
  # [ImGui::SetWindowSize()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L362)
  ...
  #
  # [ImGui::SetWindowSize()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L367)
  ...
  #
  # [ImGui::SetWindowCollapsed()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L363)
  ...
  #
  # [ImGui::SetWindowCollapsed()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L368)
  ...
  #
  # [ImGui::SetWindowFocus()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L364)
  ...
  #
  # [ImGui::SetWindowFocus()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L369)
  ...
  #
  # [ImGui::SetWindowFontScale()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L365)
  ...
  #
  # [ImGui::GetContentRegionAvail()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L374)
  ...
  #
  # [ImGui::GetContentRegionMax()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L375)
  ...
  #
  # [ImGui::GetWindowContentRegionMin()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L376)
  ...
  #
  # [ImGui::GetWindowContentRegionMax()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L377)
  ...
  #
  # [ImGui::GetScrollX()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L380)
  ...
  #
  # [ImGui::GetScrollY()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L381)
  ...
  #
  # [ImGui::SetScrollX()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L382)
  ...
  #
  # [ImGui::SetScrollY()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L383)
  ...
  #
  # [ImGui::GetScrollMaxX()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L384)
  ...
  #
  # [ImGui::GetScrollMaxY()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L385)
  ...
  #
  # [ImGui::SetScrollHereX()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L386)
  ...
  #
  # [ImGui::SetScrollHereY()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L387)
  ...
  #
  # [ImGui::SetScrollFromPosX()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L388)
  ...
  # adjust scrolling amount to make given position visible. Generally GetCursorStartPos() + offset to compute a valid position.
  #
  # [ImGui::SetScrollFromPosY()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L389)
  ...
  #
  # [ImGui::PushFont()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L392)
  def self.push_font(font : ImFont) : Void
    LibImGui.PushFont(font)
  end

  # [ImGui::PopFont()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L393)
  ...
  #
  # [ImGui::PushStyleColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L394)
  def self.push_style_color(idx : ImGuiCol, col : UInt32) : Void
    LibImGui.PushStyleColor_U32(idx, col)
  end

  # [ImGui::PushStyleColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L395)
  def self.push_style_color(idx : ImGuiCol, col : ImVec4) : Void
    LibImGui.PushStyleColor_Vec4(idx, col)
  end

  # [ImGui::PopStyleColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L396)
  ...
  #
  # [ImGui::PushStyleVar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L397)
  ...
  #
  # [ImGui::PushStyleVar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L398)
  def self.push_style_var(idx : ImGuiStyleVar, val : ImVec2) : Void
    LibImGui.PushStyleVar_Vec2(idx, val)
  end

  # [ImGui::PopStyleVar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L399)
  ...
  #
  # [ImGui::PushAllowKeyboardFocus()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L400)
  def self.push_allow_keyboard_focus(allow_keyboard_focus : Bool) : Void
    LibImGui.PushAllowKeyboardFocus(allow_keyboard_focus)
  end

  # [ImGui::PopAllowKeyboardFocus()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L401)
  ...
  #
  # [ImGui::PushButtonRepeat()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L402)
  def self.push_button_repeat(repeat : Bool) : Void
    LibImGui.PushButtonRepeat(repeat)
  end

  # [ImGui::PopButtonRepeat()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L403)
  ...
  #
  # [ImGui::PushItemWidth()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L406)
  def self.push_item_width(item_width : Float32) : Void
    LibImGui.PushItemWidth(item_width)
  end

  # [ImGui::PopItemWidth()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L407)
  ...
  #
  # [ImGui::SetNextItemWidth()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L408)
  ...
  #
  # [ImGui::CalcItemWidth()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L409)
  ...
  #
  # [ImGui::PushTextWrapPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L410)
  def self.push_text_wrap_pos(wrap_local_pos_x : Float32 = 0.0) : Void
    LibImGui.PushTextWrapPos(wrap_local_pos_x)
  end

  # [ImGui::PopTextWrapPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L411)
  ...
  # get current font
  #
  # [ImGui::GetFont()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L415)
  ...
  #
  # [ImGui::GetFontSize()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L416)
  ...
  #
  # [ImGui::GetFontTexUvWhitePixel()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L417)
  ...
  #
  # [ImGui::GetColorU32()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L418)
  ...
  #
  # [ImGui::GetColorU32()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L419)
  ...
  # retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList
  #
  # [ImGui::GetColorU32()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L420)
  ...
  #
  # [ImGui::GetStyleColorVec4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L421)
  ...
  #
  # [ImGui::Separator()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L430)
  ...
  #
  # [ImGui::SameLine()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L431)
  ...
  #
  # [ImGui::NewLine()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L432)
  ...
  #
  # [ImGui::Spacing()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L433)
  ...
  #
  # [ImGui::Dummy()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L434)
  ...
  #
  # [ImGui::Indent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L435)
  ...
  #
  # [ImGui::Unindent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L436)
  ...
  #
  # [ImGui::BeginGroup()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L437)
  ...
  #
  # [ImGui::EndGroup()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L438)
  ...
  #
  # [ImGui::GetCursorPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L439)
  ...
  #
  # [ImGui::GetCursorPosX()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L440)
  ...
  #
  # [ImGui::GetCursorPosY()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L441)
  ...
  #
  # [ImGui::SetCursorPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L442)
  ...
  #
  # [ImGui::SetCursorPosX()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L443)
  def self.set_cursor_pos_x(local_x : Float32) : Void
    LibImGui.SetCursorPosX(local_x)
  end

  # [ImGui::SetCursorPosY()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L444)
  ...
  #
  # [ImGui::GetCursorStartPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L445)
  ...
  #
  # [ImGui::GetCursorScreenPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L446)
  ...
  #
  # [ImGui::SetCursorScreenPos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L447)
  ...
  #
  # [ImGui::AlignTextToFramePadding()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L448)
  ...
  # ~ FontSize
  #
  # [ImGui::GetTextLineHeight()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L449)
  ...
  #
  # [ImGui::GetTextLineHeightWithSpacing()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L450)
  ...
  #
  # [ImGui::GetFrameHeight()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L451)
  ...
  #
  # [ImGui::GetFrameHeightWithSpacing()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L452)
  ...
  #
  # [ImGui::PushID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L465)
  ...
  # push string into the ID stack (will hash string).
  #
  # [ImGui::PushID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L466)
  ...
  #
  # [ImGui::PushID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L467)
  ...
  #
  # [ImGui::PushID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L468)
  ...
  #
  # [ImGui::PopID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L469)
  ...
  #
  # [ImGui::GetID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L470)
  def self.get_id(str_id : String) : ImGuiID
    LibImGui.GetID_Str(str_id)
  end

  # [ImGui::GetID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L471)
  def self.get_id(str_id : Bytes | String) : ImGuiID
    LibImGui.GetID_StrStr(str_id, (str_id.to_unsafe + str_id.bytesize))
  end

  # [ImGui::GetID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L472)
  ...
  #
  # [ImGui::TextUnformatted()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L475)
  ...
  # formatted text
  #
  # [ImGui::Text()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L476)
  ...
  #
  # [ImGui::TextColored()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L478)
  ...
  #
  # [ImGui::TextDisabled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L480)
  ...
  #
  # [ImGui::TextWrapped()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L482)
  ...
  #
  # [ImGui::LabelText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L484)
  ...
  #
  # [ImGui::BulletText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L486)
  ...
  # button
  #
  # [ImGui::Button()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L492)
  ...
  #
  # [ImGui::SmallButton()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L493)
  ...
  #
  # [ImGui::InvisibleButton()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L494)
  ...
  #
  # [ImGui::ArrowButton()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L495)
  def self.arrow_button(str_id : String, dir : ImGuiDir) : Bool
    LibImGui.ArrowButton(str_id, dir)
  end

  # [ImGui::Image()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L496)
  ...
  #
  # [ImGui::ImageButton()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L497)
  ...
  # [ImGui::Checkbox()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L498)
  pointer_wrapper def self.checkbox(label : String, v : Bool*) : Bool
    LibImGui.Checkbox(label, v)
  end
  # [ImGui::CheckboxFlags()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L499)
  ...
  # [ImGui::CheckboxFlags()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L500)
  ...
  #
  # [ImGui::RadioButton()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L501)
  pointer_wrapper def self.radio_button(label : String, active : Bool) : Bool
    LibImGui.RadioButton_Bool(label, active)
  end
  # shortcut to handle the above pattern when value is an integer
  #
  # [ImGui::RadioButton()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L502)
  ...
  # [ImGui::ProgressBar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L503)
  ...
  #
  # [ImGui::Bullet()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L504)
  def self.bullet : Void
    LibImGui.Bullet
  end

  # [ImGui::BeginCombo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L509)
  ...
  #
  # [ImGui::EndCombo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L510)
  def self.end_combo : Void
    LibImGui.EndCombo
  end

  # [ImGui::Combo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L511)
  ...
  #
  # [ImGui::Combo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L512)
  ...
  # [ImGui::Combo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L513)
  ...
  #
  # [ImGui::DragFloat()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L527)
  ...
  # [ImGui::DragFloat2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L528)
  ...
  # [ImGui::DragFloat3()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L529)
  ...
  # [ImGui::DragFloat4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L530)
  ...
  # [ImGui::DragFloatRange2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L531)
  ...
  # If v_min >= v_max we have no bound
  #
  # [ImGui::DragInt()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L532)
  ...
  # [ImGui::DragInt2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L533)
  ...
  # [ImGui::DragInt3()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L534)
  ...
  # [ImGui::DragInt4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L535)
  ...
  # [ImGui::DragIntRange2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L536)
  ...
  # [ImGui::DragScalar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L537)
  ...
  {% end %}
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::DragScalarN()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L538)
  ...
  #
  # [ImGui::SliderFloat()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L546)
  ...
  # [ImGui::SliderFloat2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L547)
  ...
  # [ImGui::SliderFloat3()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L548)
  ...
  # [ImGui::SliderFloat4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L549)
  ...
  # [ImGui::SliderAngle()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L550)
  ...
  # [ImGui::SliderInt()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L551)
  ...
  # [ImGui::SliderInt2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L552)
  ...
  # [ImGui::SliderInt3()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L553)
  ...
  # [ImGui::SliderInt4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L554)
  ...
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::SliderScalar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L555)
  ...
  {% end %}
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::SliderScalarN()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L556)
  ...
  {% end %}
  # [ImGui::VSliderFloat()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L557)
  ...
  # [ImGui::VSliderInt()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L558)
  ...
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::VSliderScalar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L559)
  ...
  # [ImGui::InputText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L564)
  ...
  # [ImGui::InputTextMultiline()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L565)
  ...
  # [ImGui::InputTextWithHint()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L566)
  ...
  # [ImGui::InputFloat()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L567)
  ...
  # [ImGui::InputFloat2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L568)
  ...
  # [ImGui::InputFloat3()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L569)
  ...
  # [ImGui::InputFloat4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L570)
  ...
  # [ImGui::InputInt()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L571)
  ...
  # [ImGui::InputInt2()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L572)
  ...
  # [ImGui::InputInt3()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L573)
  ...
  # [ImGui::InputInt4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L574)
  ...
  # [ImGui::InputDouble()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L575)
  ...
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::InputScalar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L576)
  ...
  {% end %}
  {% for k, t in {S8: Int8, U8: UInt8, S16: Int16, U16: UInt16, S32: Int32, U32: UInt32, S64: Int64, U64: UInt64, Float: Float32, Double: Float64} %}
  # [ImGui::InputScalarN()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L577)
  ...
  {% end %}
  # [ImGui::ColorEdit3()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L582)
  ...
  # [ImGui::ColorEdit4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L583)
  ...
  # [ImGui::ColorPicker3()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L584)
  ...
  # [ImGui::ColorPicker4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L585)
  ...
  #
  # [ImGui::ColorButton()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L586)
  ...
  #
  # [ImGui::SetColorEditOptions()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L587)
  def self.set_color_edit_options(flags : ImGuiColorEditFlags) : Void
    LibImGui.SetColorEditOptions(flags)
  end

  # [ImGui::TreeNode()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L591)
  ...
  #
  # [ImGui::TreeNode()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L592)
  ...
  # "
  #
  # [ImGui::TreeNode()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L593)
  ...
  # [ImGui::TreeNodeEx()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L596)
  ...
  # [ImGui::TreeNodeEx()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L597)
  ...
  # [ImGui::TreeNodeEx()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L598)
  ...
  #
  # [ImGui::TreePush()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L601)
  ...
  # "
  #
  # [ImGui::TreePush()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L602)
  ...
  # ~ Unindent()+PopId()
  #
  # [ImGui::TreePop()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L603)
  ...
  #
  # [ImGui::GetTreeNodeToLabelSpacing()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L604)
  ...
  #
  # [ImGui::CollapsingHeader()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L605)
  ...
  #
  # [ImGui::CollapsingHeader()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L606)
  ...
  #
  # [ImGui::SetNextItemOpen()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L607)
  ...
  #
  # [ImGui::Selectable()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L612)
  ...
  #
  # [ImGui::Selectable()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L613)
  ...
  #
  # [ImGui::BeginListBox()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L621)
  ...
  #
  # [ImGui::EndListBox()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L622)
  def self.end_list_box : Void
    LibImGui.EndListBox
  end

  # [ImGui::ListBox()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L623)
  ...
  # [ImGui::ListBox()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L624)
  ...
  # [ImGui::PlotLines()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L628)
  ...
  # [ImGui::PlotLines()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L629)
  ...
  # [ImGui::PlotHistogram()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L630)
  ...
  # [ImGui::PlotHistogram()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L631)
  ...
  # [ImGui::Value()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L635)
  def self.value(prefix : String, b : Bool) : Void
    LibImGui.Value_Bool(prefix, b)
  end

  # [ImGui::Value()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L636)
  def self.value(prefix : String, v : Int32) : Void
    LibImGui.Value_Int(prefix, v)
  end

  # [ImGui::Value()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L637)
  def self.value(prefix : String, v : UInt32) : Void
    LibImGui.Value_Uint(prefix, v)
  end

  # [ImGui::Value()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L638)
  ...
  #
  # [ImGui::BeginMenuBar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L645)
  ...
  #
  # [ImGui::EndMenuBar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L646)
  ...
  #
  # [ImGui::BeginMainMenuBar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L647)
  ...
  #
  # [ImGui::EndMainMenuBar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L648)
  ...
  #
  # [ImGui::BeginMenu()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L649)
  ...
  #
  # [ImGui::EndMenu()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L650)
  ...
  #
  # [ImGui::MenuItem()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L651)
  ...
  #
  # [ImGui::MenuItem()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L652)
  ...
  #
  # [ImGui::BeginTooltip()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L656)
  def self.begin_tooltip : Void
    LibImGui.BeginTooltip
  end

  # [ImGui::EndTooltip()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L657)
  ...
  #
  # [ImGui::SetTooltip()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L658)
  ...
  #
  # [ImGui::BeginPopup()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L673)
  ...
  #
  # [ImGui::BeginPopupModal()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L674)
  ...
  #
  # [ImGui::EndPopup()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L675)
  ...
  #
  # [ImGui::OpenPopup()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L685)
  ...
  #
  # [ImGui::OpenPopup()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L686)
  ...
  #
  # [ImGui::OpenPopupOnItemClick()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L687)
  ...
  #
  # [ImGui::CloseCurrentPopup()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L688)
  ...
  #
  # [ImGui::BeginPopupContextItem()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L695)
  ...
  #
  # [ImGui::BeginPopupContextWindow()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L696)
  ...
  #
  # [ImGui::BeginPopupContextVoid()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L697)
  ...
  #
  # [ImGui::IsPopupOpen()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L703)
  ...
  # [ImGui::BeginTable()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L729)
  ...
  #
  # [ImGui::EndTable()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L730)
  ...
  #
  # [ImGui::TableNextRow()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L731)
  ...
  #
  # [ImGui::TableNextColumn()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L732)
  ...
  #
  # [ImGui::TableSetColumnIndex()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L733)
  def self.table_set_column_index(column_n : Int32) : Bool
    LibImGui.TableSetColumnIndex(column_n)
  end

  # [ImGui::TableSetupColumn()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L743)
  ...
  #
  # [ImGui::TableSetupScrollFreeze()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L744)
  ...
  #
  # [ImGui::TableHeadersRow()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L745)
  ...
  #
  # [ImGui::TableHeader()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L746)
  ...
  #
  # [ImGui::TableGetSortSpecs()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L754)
  ...
  #
  # [ImGui::TableGetColumnCount()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L758)
  ...
  #
  # [ImGui::TableGetColumnIndex()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L759)
  ...
  #
  # [ImGui::TableGetRowIndex()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L760)
  ...
  #
  # [ImGui::TableGetColumnName()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L761)
  ...
  #
  # [ImGui::TableGetColumnFlags()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L762)
  ...
  #
  # [ImGui::TableSetColumnEnabled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L763)
  ...
  #
  # [ImGui::TableSetBgColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L764)
  ...
  # [ImGui::Columns()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L768)
  ...
  #
  # [ImGui::NextColumn()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L769)
  ...
  #
  # [ImGui::GetColumnIndex()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L770)
  ...
  #
  # [ImGui::GetColumnWidth()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L771)
  ...
  #
  # [ImGui::SetColumnWidth()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L772)
  ...
  #
  # [ImGui::GetColumnOffset()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L773)
  ...
  #
  # [ImGui::SetColumnOffset()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L774)
  def self.set_column_offset(column_index : Int32, offset_x : Float32) : Void
    LibImGui.SetColumnOffset(column_index, offset_x)
  end

  # [ImGui::GetColumnsCount()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L775)
  ...
  #
  # [ImGui::BeginTabBar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L778)
  ...
  #
  # [ImGui::EndTabBar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L779)
  ...
  #
  # [ImGui::BeginTabItem()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L780)
  ...
  #
  # [ImGui::EndTabItem()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L781)
  ...
  #
  # [ImGui::TabItemButton()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L782)
  ...
  #
  # [ImGui::SetTabItemClosed()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L783)
  ...
  #
  # [ImGui::LogToTTY()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L787)
  ...
  #
  # [ImGui::LogToFile()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L788)
  ...
  #
  # [ImGui::LogToClipboard()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L789)
  ...
  #
  # [ImGui::LogFinish()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L790)
  ...
  #
  # [ImGui::LogButtons()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L791)
  ...
  #
  # [ImGui::LogText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L792)
  ...
  #
  # [ImGui::BeginDragDropSource()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L800)
  ...
  #
  # [ImGui::SetDragDropPayload()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L801)
  ...
  #
  # [ImGui::EndDragDropSource()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L802)
  ...
  #
  # [ImGui::BeginDragDropTarget()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L803)
  ...
  #
  # [ImGui::AcceptDragDropPayload()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L804)
  ...
  #
  # [ImGui::EndDragDropTarget()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L805)
  ...
  #
  # [ImGui::GetDragDropPayload()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L806)
  def self.get_drag_drop_payload : ImGuiPayload?
    result = LibImGui.GetDragDropPayload
    result ? ImGuiPayload.new(result) : nil
  end

  # [ImGui::BeginDisabled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L812)
  def self.begin_disabled(disabled : Bool = true) : Void
    LibImGui.BeginDisabled(disabled)
  end

  # [ImGui::EndDisabled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L813)
  def self.end_disabled : Void
    LibImGui.EndDisabled
  end

  # [ImGui::PushClipRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L817)
  ...
  # [ImGui::PopClipRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L818)
  ...
  #
  # [ImGui::SetItemDefaultFocus()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L822)
  ...
  #
  # [ImGui::SetKeyboardFocusHere()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L823)
  ...
  #
  # [ImGui::IsItemHovered()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L828)
  ...
  #
  # [ImGui::IsItemActive()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L829)
  ...
  #
  # [ImGui::IsItemFocused()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L830)
  ...
  #
  # [ImGui::IsItemClicked()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L831)
  ...
  #
  # [ImGui::IsItemVisible()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L832)
  ...
  #
  # [ImGui::IsItemEdited()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L833)
  ...
  #
  # [ImGui::IsItemActivated()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L834)
  ...
  #
  # [ImGui::IsItemDeactivated()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L835)
  ...
  #
  # [ImGui::IsItemDeactivatedAfterEdit()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L836)
  ...
  #
  # [ImGui::IsItemToggledOpen()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L837)
  ...
  # is any item hovered?
  #
  # [ImGui::IsAnyItemHovered()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L838)
  ...
  # is any item active?
  #
  # [ImGui::IsAnyItemActive()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L839)
  ...
  # is any item focused?
  #
  # [ImGui::IsAnyItemFocused()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L840)
  ...
  #
  # [ImGui::GetItemRectMin()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L841)
  ...
  #
  # [ImGui::GetItemRectMax()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L842)
  ...
  #
  # [ImGui::GetItemRectSize()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L843)
  ...
  #
  # [ImGui::SetItemAllowOverlap()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L844)
  ...
  #
  # [ImGui::GetMainViewport()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L850)
  ...
  #
  # [ImGui::IsRectVisible()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L853)
  ...
  #
  # [ImGui::IsRectVisible()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L854)
  ...
  #
  # [ImGui::GetTime()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L855)
  ...
  #
  # [ImGui::GetFrameCount()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L856)
  ...
  #
  # [ImGui::GetBackgroundDrawList()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L857)
  ...
  #
  # [ImGui::GetForegroundDrawList()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L858)
  ...
  #
  # [ImGui::GetDrawListSharedData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L859)
  ...
  #
  # [ImGui::GetStyleColorName()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L860)
  ...
  #
  # [ImGui::SetStateStorage()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L861)
  def self.set_state_storage(storage : ImGuiStorage*) : Void
    LibImGui.SetStateStorage(storage)
  end

  # [ImGui::GetStateStorage()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L862)
  ...
  #
  # [ImGui::BeginChildFrame()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L863)
  ...
  #
  # [ImGui::EndChildFrame()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L864)
  def self.end_child_frame : Void
    LibImGui.EndChildFrame
  end

  # [ImGui::CalcTextSize()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L867)
  ...
  # [ImGui::ColorConvertU32ToFloat4()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L870)
  def self.color_convert_u32_to_float4(in_ : UInt32) : ImGui::ImVec4
    LibImGui.ColorConvertU32ToFloat4(out p_out, in_)
    p_out
  end

  # [ImGui::ColorConvertFloat4ToU32()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L871)
  def self.color_convert_float4_to_u32(in_ : ImVec4) : UInt32
    LibImGui.ColorConvertFloat4ToU32(in_)
  end

  # [ImGui::ColorConvertRGBtoHSV()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L872)
  ...
  # [ImGui::ColorConvertHSVtoRGB()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L873)
  ...
  # is key being held.
  #
  # [ImGui::IsKeyDown()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L881)
  def self.is_key_down(key : ImGuiKey) : Bool
    LibImGui.IsKeyDown(key)
  end

  # was key pressed (went from !Down to Down)? if repeat=true, uses io.KeyRepeatDelay / KeyRepeatRate
  #
  # [ImGui::IsKeyPressed()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L882)
  def self.is_key_pressed(key : ImGuiKey, repeat : Bool = true) : Bool
    LibImGui.IsKeyPressed(key, repeat)
  end

  # was key released (went from Down to !Down)?
  #
  # [ImGui::IsKeyReleased()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L883)
  def self.is_key_released(key : ImGuiKey) : Bool
    LibImGui.IsKeyReleased(key)
  end

  # uses provided repeat rate/delay. return a count, most often 0 or 1 but might be >1 if RepeatRate is small enough that DeltaTime > RepeatRate
  #
  # [ImGui::GetKeyPressedAmount()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L884)
  ...
  #
  # [ImGui::GetKeyName()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L885)
  ...
  #
  # [ImGui::CaptureKeyboardFromApp()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L886)
  ...
  #
  # [ImGui::IsMouseDown()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L892)
  ...
  #
  # [ImGui::IsMouseClicked()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L893)
  ...
  #
  # [ImGui::IsMouseReleased()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L894)
  ...
  #
  # [ImGui::IsMouseDoubleClicked()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L895)
  ...
  #
  # [ImGui::GetMouseClickedCount()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L896)
  ...
  #
  # [ImGui::IsMouseHoveringRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L897)
  ...
  #
  # [ImGui::IsMousePosValid()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L898)
  ...
  #
  # [ImGui::IsAnyMouseDown()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L899)
  ...
  #
  # [ImGui::GetMousePos()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L900)
  ...
  #
  # [ImGui::GetMousePosOnOpeningCurrentPopup()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L901)
  ...
  #
  # [ImGui::IsMouseDragging()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L902)
  ...
  #
  # [ImGui::GetMouseDragDelta()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L903)
  ...
  # [ImGui::ResetMouseDragDelta()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L904)
  ...
  #
  # [ImGui::GetMouseCursor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L905)
  ...
  #
  # [ImGui::SetMouseCursor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L906)
  ...
  #
  # [ImGui::CaptureMouseFromApp()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L907)
  ...
  # [ImGui::GetClipboardText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L911)
  def self.get_clipboard_text : String
    result = LibImGui.GetClipboardText
    String.new(result)
  end

  # [ImGui::SetClipboardText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L912)
  ...
  #
  # [ImGui::LoadIniSettingsFromDisk()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L918)
  ...
  #
  # [ImGui::LoadIniSettingsFromMemory()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L919)
  ...
  #
  # [ImGui::SaveIniSettingsToDisk()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L920)
  ...
  #
  # [ImGui::SaveIniSettingsToMemory()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L921)
  ...
  #
  # [ImGui::DebugCheckVersionAndDataLayout()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L925)
  ...
  # [ImGui::SetAllocatorFunctions()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L931)
  ...
  # [ImGui::GetAllocatorFunctions()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L932)
  ...
  # [ImGui::MemAlloc()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L933)
  def self.mem_alloc(size : LibC::SizeT) : Void*
    LibImGui.MemAlloc(size)
  end

  # [ImGui::MemFree()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L934)
  def self.mem_free(ptr : Void*) : Void
    LibImGui.MemFree(ptr)
  end

  # [struct ImVector](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1768)
  struct ImVector
    include StructType
  end

  # [struct ImGuiStyle](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1838)
  struct ImGuiStyle
    ...
    # [ImGuiStyle::ImGuiStyle()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1882)
    def self.new : ImGuiStyle
      result = LibImGui.ImGuiStyle_ImGuiStyle
      ImGuiStyle.new(result)
    end

    # [ImGuiStyle::ScaleAllSizes()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1883)
  ...
  # [struct ImGuiKeyData](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1895)
  struct ImGuiKeyData
  ...
  # [struct ImGuiIO](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1903)
  struct ImGuiIO
    ...
    #
    # [ImGuiIO::AddKeyEvent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1971)
    ...
    #
    # [ImGuiIO::AddKeyAnalogEvent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1972)
    ...
    #
    # [ImGuiIO::AddMousePosEvent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1973)
    ...
    #
    # [ImGuiIO::AddMouseButtonEvent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1974)
    ...
    #
    # [ImGuiIO::AddMouseWheelEvent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1975)
    ...
    #
    # [ImGuiIO::AddFocusEvent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1976)
    ...
    #
    # [ImGuiIO::AddInputCharacter()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1977)
    ...
    #
    # [ImGuiIO::AddInputCharacterUTF16()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1978)
    ...
    #
    # [ImGuiIO::AddInputCharactersUTF8()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1979)
    ...
    #
    # [ImGuiIO::ClearInputCharacters()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1981)
    ...
    #
    # [ImGuiIO::ClearInputKeys()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1982)
    ...
    #
    # [ImGuiIO::SetKeyEventNativeData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L1983)
    ...
    # [ImGuiIO::ImGuiIO()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2057)
  ...
  # [struct ImGuiInputTextCallbackData](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2073)
  struct ImGuiInputTextCallbackData
    ...
    # [ImGuiInputTextCallbackData::ImGuiInputTextCallbackData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2094)
    ...
    # [ImGuiInputTextCallbackData::DeleteChars()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2095)
    def delete_chars(pos : Int32, bytes_count : Int32) : Void
      LibImGui.ImGuiInputTextCallbackData_DeleteChars(self, pos, bytes_count)
    end

    # [ImGuiInputTextCallbackData::InsertChars()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2096)
    ...
    # [ImGuiInputTextCallbackData::SelectAll()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2097)
    def select_all : Void
      LibImGui.ImGuiInputTextCallbackData_SelectAll(self)
    end

    # [ImGuiInputTextCallbackData::ClearSelection()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2098)
    def clear_selection : Void
      LibImGui.ImGuiInputTextCallbackData_ClearSelection(self)
    end

    # [ImGuiInputTextCallbackData::HasSelection()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2099)
  ...
  # [struct ImGuiSizeCallbackData](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2104)
  ...
  # [struct ImGuiPayload](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2113)
  struct ImGuiPayload
    ...
    # [ImGuiPayload::ImGuiPayload()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2127)
    def self.new : ImGuiPayload
      result = LibImGui.ImGuiPayload_ImGuiPayload
      ImGuiPayload.new(result)
    end

    # [ImGuiPayload::Clear()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2128)
    def clear : Void
      LibImGui.ImGuiPayload_Clear(self)
    end

    # [ImGuiPayload::IsDataType()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2129)
    def is_data_type(type : String) : Bool
      LibImGui.ImGuiPayload_IsDataType(self, type)
    end

    # [ImGuiPayload::IsPreview()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2130)
    def is_preview : Bool
      LibImGui.ImGuiPayload_IsPreview(self)
    end

    # [ImGuiPayload::IsDelivery()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2131)
  ...
  # [struct ImGuiTableColumnSortSpecs](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2135)
  struct ImGuiTableColumnSortSpecs
    ...
    # [ImGuiTableColumnSortSpecs::ImGuiTableColumnSortSpecs()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2142)
  ...
  # [struct ImGuiTableSortSpecs](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2149)
  struct ImGuiTableSortSpecs
    ...
    # [ImGuiTableSortSpecs::ImGuiTableSortSpecs()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2155)
  ...
  # [struct ImGuiOnceUponAFrame](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2172)
  struct ImGuiOnceUponAFrame
    include StructType

    # [ImGuiOnceUponAFrame::ImGuiOnceUponAFrame()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2174)
  ...
  # [struct ImGuiTextFilter](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2180)
  struct ImGuiTextFilter
    ...
    # [ImGuiTextFilter::ImGuiTextFilter()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2182)
    ...
    #
    # [ImGuiTextFilter::Draw()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2183)
    def draw(label : String = "Filter(inc,-exc)", width : Float32 = 0.0) : Bool
      LibImGui.ImGuiTextFilter_Draw(self, label, width)
    end

    # [ImGuiTextFilter::PassFilter()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2184)
    def pass_filter(text : Bytes | String) : Bool
      LibImGui.ImGuiTextFilter_PassFilter(self, text, (text.to_unsafe + text.bytesize))
    end

    # [ImGuiTextFilter::Build()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2185)
    def build : Void
      LibImGui.ImGuiTextFilter_Build(self)
    end

    # [ImGuiTextFilter::Clear()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2186)
    def clear : Void
      LibImGui.ImGuiTextFilter_Clear(self)
    end

    # [ImGuiTextFilter::IsActive()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2187)
    def is_active : Bool
  ...
  # [struct ImGuiStorage](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2234)
  struct ImGuiStorage
    include StructType
    ...
    # [ImGuiStorage::Clear()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2251)
    def clear : Void
      LibImGui.ImGuiStorage_Clear(self)
    end

    # [ImGuiStorage::GetInt()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2252)
    def get_int(key : ImGuiID, default_val : Int32 = 0) : Int32
      LibImGui.ImGuiStorage_GetInt(self, key, default_val)
    end

    # [ImGuiStorage::SetInt()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2253)
    def set_int(key : ImGuiID, val : Int32) : Void
      LibImGui.ImGuiStorage_SetInt(self, key, val)
    end

    # [ImGuiStorage::GetBool()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2254)
    def get_bool(key : ImGuiID, default_val : Bool = false) : Bool
      LibImGui.ImGuiStorage_GetBool(self, key, default_val)
    end

    # [ImGuiStorage::SetBool()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2255)
    def set_bool(key : ImGuiID, val : Bool) : Void
      LibImGui.ImGuiStorage_SetBool(self, key, val)
    end

    # [ImGuiStorage::GetFloat()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2256)
    def get_float(key : ImGuiID, default_val : Float32 = 0.0) : Float32
      LibImGui.ImGuiStorage_GetFloat(self, key, default_val)
    end

    # [ImGuiStorage::SetFloat()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2257)
    ...
    # [ImGuiStorage::SetAllInt()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2271)
    def set_all_int(val : Int32) : Void
      LibImGui.ImGuiStorage_SetAllInt(self, val)
    end

    # [ImGuiStorage::BuildSortByKey()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2274)
    def build_sort_by_key : Void
      LibImGui.ImGuiStorage_BuildSortByKey(self)
    end
  end

  # [struct ImGuiListClipper](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2297)
  struct ImGuiListClipper
    include StructType

    # [ImGuiListClipper::ImGuiListClipper()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2308)
    def self.new : ImGuiListClipper
      result = LibImGui.ImGuiListClipper_ImGuiListClipper
      result.value
    end

    # [ImGuiListClipper::Begin()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2310)
    ...
    #
    # [ImGuiListClipper::End()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2311)
    def end : Void
    ...
    #
    # [ImGuiListClipper::Step()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2312)
    def step : Bool
    ...
    #
    # [ImGuiListClipper::ForceDisplayRangeByIndices()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2315)
  ...
  # [struct ImColor](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2345)
  struct ImColor
    include StructType

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2349)
    def self.new : ImColor
      result = LibImGui.ImColor_ImColor_Nil
      result.value
    end

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2350)
    def self.new(r : Int32, g : Int32, b : Int32, a : Int32 = 255) : ImColor
      result = LibImGui.ImColor_ImColor_Int(r, g, b, a)
      result.value
    end

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2351)
    def self.new(rgba : UInt32) : ImColor
      result = LibImGui.ImColor_ImColor_U32(rgba)
      result.value
    end

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2352)
    def self.new(r : Float32, g : Float32, b : Float32, a : Float32 = 1.0) : ImColor
      result = LibImGui.ImColor_ImColor_Float(r, g, b, a)
      result.value
    end

    # [ImColor::ImColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2353)
    def self.new(col : ImVec4) : ImColor
      result = LibImGui.ImColor_ImColor_Vec4(col)
      result.value
    end

    # [ImColor::SetHSV()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2358)
    def set_hsv(h : Float32, s : Float32, v : Float32, a : Float32 = 1.0) : Void
      LibImGui.ImColor_SetHSV(self, h, s, v, a)
    end

    # [ImColor::HSV()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2359)
  ...
  # [struct ImDrawCmd](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2394)
  struct ImDrawCmd
    ...
    #
    # [ImDrawCmd::ImDrawCmd()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2404)
    def self.new : ImDrawCmd
      result = LibImGui.ImDrawCmd_ImDrawCmd
      ImDrawCmd.new(result)
    end

    # [ImDrawCmd::GetTexID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2407)
  ...
  # [struct ImDrawVert](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2412)
  struct ImDrawVert
    include StructType
  end

  # [struct ImDrawCmdHeader](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2427)
  ...
  # [struct ImDrawChannel](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2435)
  struct ImDrawChannel
    include StructType
  end

  # [struct ImDrawListSplitter](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2444)
  struct ImDrawListSplitter
    include ClassType(LibImGui::ImDrawListSplitter)

    # [ImDrawListSplitter::ImDrawListSplitter()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2450)
    ...
    #
    # [ImDrawListSplitter::Clear()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2452)
    def clear : Void
      LibImGui.ImDrawListSplitter_Clear(self)
    end

    # [ImDrawListSplitter::ClearFreeMemory()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2453)
    def clear_free_memory : Void
      LibImGui.ImDrawListSplitter_ClearFreeMemory(self)
    end

    # [ImDrawListSplitter::Split()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2454)
    def split(draw_list : ImDrawList, count : Int32) : Void
      LibImGui.ImDrawListSplitter_Split(self, draw_list, count)
    end

    # [ImDrawListSplitter::Merge()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2455)
    def merge(draw_list : ImDrawList) : Void
      LibImGui.ImDrawListSplitter_Merge(self, draw_list)
    end

    # [ImDrawListSplitter::SetCurrentChannel()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2456)
  ...
  # [struct ImDrawList](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2499)
  struct ImDrawList
    ...
    # [ImDrawList::ImDrawList()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2521)
    ...
    #
    # [ImDrawList::PushClipRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2524)
    ...
    # [ImDrawList::PushClipRectFullScreen()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2525)
    def push_clip_rect_full_screen : Void
      LibImGui.ImDrawList_PushClipRectFullScreen(self)
    end

    # [ImDrawList::PopClipRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2526)
    def pop_clip_rect : Void
      LibImGui.ImDrawList_PopClipRect(self)
    end

    # [ImDrawList::PushTextureID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2527)
    def push_texture_id(texture_id : ImTextureID) : Void
      LibImGui.ImDrawList_PushTextureID(self, texture_id)
    end

    # [ImDrawList::PopTextureID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2528)
    def pop_texture_id : Void
      LibImGui.ImDrawList_PopTextureID(self)
    end

    # [ImDrawList::GetClipRectMin()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2529)
    def get_clip_rect_min : ImGui::ImVec2
      LibImGui.ImDrawList_GetClipRectMin(out p_out, self)
      p_out
    end

    # [ImDrawList::GetClipRectMax()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2530)
    def get_clip_rect_max : ImGui::ImVec2
      LibImGui.ImDrawList_GetClipRectMax(out p_out, self)
      p_out
    end

    # [ImDrawList::AddLine()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2538)
    ...
    #
    # [ImDrawList::AddRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2539)
    ...
    # a: upper-left, b: lower-right (== upper-left + size)
    #
    # [ImDrawList::AddRectFilled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2540)
    ...
    # [ImDrawList::AddRectFilledMultiColor()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2541)
    ...
    # [ImDrawList::AddQuad()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2542)
    ...
    # [ImDrawList::AddQuadFilled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2543)
    ...
    # [ImDrawList::AddTriangle()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2544)
    ...
    # [ImDrawList::AddTriangleFilled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2545)
    ...
    # [ImDrawList::AddCircle()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2546)
    ...
    # [ImDrawList::AddCircleFilled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2547)
    ...
    # [ImDrawList::AddNgon()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2548)
    ...
    # [ImDrawList::AddNgonFilled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2549)
    ...
    # [ImDrawList::AddText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2550)
    ...
    # [ImDrawList::AddText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2551)
    ...
    # [ImDrawList::AddPolyline()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2552)
    ...
    #
    # [ImDrawList::AddConvexPolyFilled()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2553)
    ...
    #
    # [ImDrawList::AddBezierCubic()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2554)
    ...
    #
    # [ImDrawList::AddBezierQuadratic()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2555)
    ...
    # [ImDrawList::AddImage()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2561)
    ...
    # [ImDrawList::AddImageQuad()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2562)
    ...
    # [ImDrawList::AddImageRounded()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2563)
    ...
    # [ImDrawList::PathClear()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2566)
    def path_clear : Void
      LibImGui.ImDrawList_PathClear(self)
    end

    # [ImDrawList::PathLineTo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2567)
    def path_line_to(pos : ImVec2) : Void
      LibImGui.ImDrawList_PathLineTo(self, pos)
    end

    # [ImDrawList::PathLineToMergeDuplicate()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2568)
    ...
    # Note: Anti-aliased filling requires points to be in clockwise order.
    #
    # [ImDrawList::PathFillConvex()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2569)
    def path_fill_convex(col : UInt32) : Void
      LibImGui.ImDrawList_PathFillConvex(self, col)
    end

    # [ImDrawList::PathStroke()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2570)
    ...
    # [ImDrawList::PathArcTo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2571)
    ...
    #
    # [ImDrawList::PathArcToFast()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2572)
    ...
    # Cubic Bezier (4 control points)
    #
    # [ImDrawList::PathBezierCubicCurveTo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2573)
    ...
    # Quadratic Bezier (3 control points)
    #
    # [ImDrawList::PathBezierQuadraticCurveTo()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2574)
    ...
    # [ImDrawList::PathRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2575)
    ...
    #
    # [ImDrawList::AddCallback()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2578)
    ...
    #
    # [ImDrawList::AddDrawCmd()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2579)
    ...
    #
    # [ImDrawList::CloneOutput()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2580)
    def clone_output : ImDrawList
      result = LibImGui.ImDrawList_CloneOutput(self)
      ImDrawList.new(result)
    end

    # [ImDrawList::ChannelsSplit()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2588)
    def channels_split(count : Int32) : Void
      LibImGui.ImDrawList_ChannelsSplit(self, count)
    end

    # [ImDrawList::ChannelsMerge()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2589)
    def channels_merge : Void
      LibImGui.ImDrawList_ChannelsMerge(self)
    end

    # [ImDrawList::ChannelsSetCurrent()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2590)
    def channels_set_current(n : Int32) : Void
      LibImGui.ImDrawList_ChannelsSetCurrent(self, n)
    end

    # [ImDrawList::PrimReserve()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2595)
    def prim_reserve(idx_count : Int32, vtx_count : Int32) : Void
      LibImGui.ImDrawList_PrimReserve(self, idx_count, vtx_count)
    end

    # [ImDrawList::PrimUnreserve()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2596)
    ...
    #
    # [ImDrawList::PrimRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2597)
    def prim_rect(a : ImVec2, b : ImVec2, col : UInt32) : Void
      LibImGui.ImDrawList_PrimRect(self, a, b, col)
    end

    # [ImDrawList::PrimRectUV()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2598)
    ...
    # [ImDrawList::PrimQuadUV()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2599)
    ...
    # [ImDrawList::PrimWriteVtx()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2600)
    def prim_write_vtx(pos : ImVec2, uv : ImVec2, col : UInt32) : Void
      LibImGui.ImDrawList_PrimWriteVtx(self, pos, uv, col)
    end

    # [ImDrawList::PrimWriteIdx()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2601)
    ...
    #
    # [ImDrawList::PrimVtx()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2602)
  ...
  # [struct ImDrawData](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2625)
  struct ImDrawData
    ...
    # [ImDrawData::ImDrawData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2637)
    ...
    #
    # [ImDrawData::Clear()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2638)
    def clear : Void
    ...
    #
    # [ImDrawData::DeIndexAllBuffers()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2639)
    ...
    #
    # [ImDrawData::ScaleClipRects()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2640)
  ...
  # [struct ImFontConfig](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2647)
  struct ImFontConfig
    ...
    # [ImFontConfig::ImFontConfig()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2671)
  ...
  # [struct ImFontGlyph](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2676)
  struct ImFontGlyph
    include StructType
  end

  # [struct ImFontGlyphRangesBuilder](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2688)
  struct ImFontGlyphRangesBuilder
    ...
    # [ImFontGlyphRangesBuilder::ImFontGlyphRangesBuilder()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2692)
    def self.new : ImFontGlyphRangesBuilder
      result = LibImGui.ImFontGlyphRangesBuilder_ImFontGlyphRangesBuilder
      result.value
    end

    # [ImFontGlyphRangesBuilder::Clear()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2693)
    def clear : Void
    ...
    #
    # [ImFontGlyphRangesBuilder::GetBit()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2694)
    ...
    #
    # [ImFontGlyphRangesBuilder::SetBit()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2695)
    ...
    # Add character
    #
    # [ImFontGlyphRangesBuilder::AddChar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2696)
    ...
    #
    # [ImFontGlyphRangesBuilder::AddText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2697)
    ...
    #
    # [ImFontGlyphRangesBuilder::AddRanges()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2698)
    ...
    # Output new ranges
    #
    # [ImFontGlyphRangesBuilder::BuildRanges()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2699)
  ...
  # [struct ImFontAtlasCustomRect](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2703)
  struct ImFontAtlasCustomRect
    ...
    # [ImFontAtlasCustomRect::ImFontAtlasCustomRect()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2711)
    ...
    # [ImFontAtlasCustomRect::IsPacked()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2712)
    def is_packed : Bool
  ...
  # [struct ImFontAtlas](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2741)
  struct ImFontAtlas
    ...
    # [ImFontAtlas::ImFontAtlas()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2743)
    def self.new : ImFontAtlas
      result = LibImGui.ImFontAtlas_ImFontAtlas
      ImFontAtlas.new(result)
    end

    # [ImFontAtlas::AddFont()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2745)
    def add_font(font_cfg : ImFontConfig) : ImFont
      result = LibImGui.ImFontAtlas_AddFont(self, font_cfg)
      ImFont.new(result)
    end

    # [ImFontAtlas::AddFontDefault()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2746)
    def add_font_default(font_cfg : ImFontConfig? = nil) : ImFont
      result = LibImGui.ImFontAtlas_AddFontDefault(self, font_cfg)
      ImFont.new(result)
    end

    # [ImFontAtlas::AddFontFromFileTTF()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2747)
    ...
    #
    # [ImFontAtlas::AddFontFromMemoryTTF()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2748)
    ...
    #
    # [ImFontAtlas::AddFontFromMemoryCompressedTTF()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2749)
    ...
    #
    # [ImFontAtlas::AddFontFromMemoryCompressedBase85TTF()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2750)
    ...
    #
    # [ImFontAtlas::ClearInputData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2751)
    ...
    #
    # [ImFontAtlas::ClearTexData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2752)
    ...
    #
    # [ImFontAtlas::ClearFonts()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2753)
    ...
    #
    # [ImFontAtlas::Clear()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2754)
    def clear : Void
    ...
    #
    # [ImFontAtlas::Build()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2761)
    def build : Bool
    ...
    # 1 byte per-pixel
    #
    # [ImFontAtlas::GetTexDataAsAlpha8()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2762)
    ...
    # 4 bytes-per-pixel
    #
    # [ImFontAtlas::GetTexDataAsRGBA32()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2763)
    ...
    #
    # [ImFontAtlas::IsBuilt()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2764)
    def is_built : Bool
      LibImGui.ImFontAtlas_IsBuilt(self)
    end

    # [ImFontAtlas::SetTexID()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2765)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesDefault()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2774)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesKorean()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2775)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesJapanese()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2776)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesChineseFull()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2777)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesChineseSimplifiedCommon()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2778)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesCyrillic()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2779)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesThai()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2780)
    ...
    #
    # [ImFontAtlas::GetGlyphRangesVietnamese()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2781)
    def get_glyph_ranges_vietnamese : ImWchar*
      LibImGui.ImFontAtlas_GetGlyphRangesVietnamese(self)
    end

    # [ImFontAtlas::AddCustomRectRegular()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2794)
    def add_custom_rect_regular(width : Int32, height : Int32) : Int32
      LibImGui.ImFontAtlas_AddCustomRectRegular(self, width, height)
    end

    # [ImFontAtlas::AddCustomRectFontGlyph()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2795)
    ...
    # [ImFontAtlas::GetCustomRectByIndex()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2796)
    ...
    # [ImFontAtlas::CalcCustomRectUV()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2799)
    ...
    # [ImFontAtlas::GetMouseCursorTexData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2800)
  ...
  # [struct ImFont](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2842)
  struct ImFont
    ...
    # [ImFont::ImFont()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2868)
    def self.new : ImFont
      result = LibImGui.ImFont_ImFont
      ImFont.new(result)
    end

    # [ImFont::FindGlyph()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2870)
    def find_glyph(c : ImWchar) : ImFontGlyph
      result = LibImGui.ImFont_FindGlyph(self, c)
      result.value
    end

    # [ImFont::FindGlyphNoFallback()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2871)
    def find_glyph_no_fallback(c : ImWchar) : ImFontGlyph
      result = LibImGui.ImFont_FindGlyphNoFallback(self, c)
      result.value
    end

    # [ImFont::GetCharAdvance()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2872)
    def get_char_advance(c : ImWchar) : Float32
      LibImGui.ImFont_GetCharAdvance(self, c)
    end

    # [ImFont::IsLoaded()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2873)
    def is_loaded : Bool
      LibImGui.ImFont_IsLoaded(self)
    end

    # [ImFont::GetDebugName()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2874)
    ...
    # utf8
    #
    # [ImFont::CalcTextSizeA()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2878)
    ...
    # [ImFont::CalcWordWrapPositionA()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2879)
    ...
    # [ImFont::RenderChar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2880)
    ...
    # [ImFont::RenderText()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2881)
    ...
    # [ImFont::BuildLookupTable()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2884)
    def build_lookup_table : Void
      LibImGui.ImFont_BuildLookupTable(self)
    end

    # [ImFont::ClearOutputData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2885)
    def clear_output_data : Void
      LibImGui.ImFont_ClearOutputData(self)
    end

    # [ImFont::GrowIndex()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2886)
    def grow_index(new_size : Int32) : Void
      LibImGui.ImFont_GrowIndex(self, new_size)
    end

    # [ImFont::AddGlyph()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2887)
    ...
    #
    # [ImFont::AddRemapChar()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2888)
    ...
    # [ImFont::SetGlyphVisible()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2889)
    def set_glyph_visible(c : ImWchar, visible : Bool) : Void
      LibImGui.ImFont_SetGlyphVisible(self, c, visible)
    end

    # [ImFont::IsGlyphRangeUnused()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2890)
  ...
  # [struct ImGuiViewport](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2913)
  struct ImGuiViewport
    ...
    # [ImGuiViewport::ImGuiViewport()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2924)
    def self.new : ImGuiViewport
      result = LibImGui.ImGuiViewport_ImGuiViewport
      ImGuiViewport.new(result)
    end

    # [ImGuiViewport::GetCenter()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2927)
    def get_center : ImGui::ImVec2
      LibImGui.ImGuiViewport_GetCenter(out p_out, self)
      p_out
    end

    # [ImGuiViewport::GetWorkCenter()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2928)
  ...
  # [struct ImGuiPlatformImeData](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2936)
  struct ImGuiPlatformImeData
    ...
    # [ImGuiPlatformImeData::ImGuiPlatformImeData()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2942)
  ...
  #
  # [ImGui::GetKeyIndex()](https://github.com/ocornut/imgui/blob/v1.87/imgui.h#L2954)
  def self.get_key_index(key : ImGuiKey) : Int32
